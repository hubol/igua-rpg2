...
export namespace OgmoEntities {
  ...
  export type EnemyMiffed = OgmoFactory.EntityBase<{ name: string; depth: number; variant: "level0" | "level1" | "level2" | "level3" | "level4" }> & { uid: number };
  export type EnemyCactus = OgmoFactory.EntityBase<{ variant: "level0" | "level1" | "level2"; name: string; depth: number }>;
  ...
  export type EnemyBrick = OgmoFactory.EntityBase<{ variant: "level0" | "level1"; name: string; depth: number }> & { uid: number };
  ...
  export type AnyObject = OgmoFactory.EntityBase<{
    objId:
      | "objAngelBallon"
      | "objAngelBouncing"
      | "objAngelSnail"
      ...
      | "objEsotericHotPineConeTree"
      | "objEsotericInProgressOrder"
      | "objEsotericOutOfOrderSign"
      | "objEsotericRemovedShoes"
      | "objEsotericWizardOfLightStatue"
      | "objFallenBot"
      | "objFlopCollectionIndicator"
      | "objFloppyDisk"
      | "objFxAsterisk16Px"
      | "objFxBallonPop"
      | "objFxBubble4"
      ...
      | "objFxBurstRound24"
      | "objFxCigarette"
      | "objFxCollectEquipmentNotification"
      | "objFxCollectPotionNotification"
      | "objFxEighthNote"
      | "objFxEmoAura24px"
      ...
      | "objFxSparkle40Px"
      | "objFxSparkleMany"
      | "objFxSpiritualRelease"
      | "objFxStarburst54"
      | "objFxSuperDust"
      | "objHeliumExhaust"
      | "objHud"
      | "objItemAngelCommon"
      | "objItemAngelDropperQueue"
      | "objLootForestSpirit"
      | "objMarker"
      | "objMusician"
      | "objOverlay"
