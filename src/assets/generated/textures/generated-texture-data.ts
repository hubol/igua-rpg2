...
const atlases = [{ url: require("./atlas0.png"), texturesCount: 174 }];
...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      ...
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 776, y: 362, width: 8, height: 8 }),
    ...
    Effects: {
      ...
      Star12px: tx({ id: "Effects.Star12px", atlas: 0, x: 717, y: 468, width: 12, height: 10 }),
    ...
    Enemy: {
      ...
      Suggestive: {
        ...
        Sclera: tx({ id: "Enemy.Suggestive.Sclera", atlas: 0, x: 442, y: 438, width: 8, height: 16 }),
    ...
    Foliage: {
      Flower14: tx({ id: "Foliage.Flower14", atlas: 0, x: 793, y: 461, width: 14, height: 8 }),
      Flower18: tx({ id: "Foliage.Flower18", atlas: 0, x: 1006, y: 126, width: 18, height: 10 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 300, y: 459, width: 16, height: 16 }),
      ...
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 317, y: 449, width: 26, height: 31 }),
      RootMedium0: tx({ id: "Foliage.RootMedium0", atlas: 0, x: 344, y: 438, width: 48, height: 19 }),
      Small: tx({ id: "Foliage.Small", atlas: 0, x: 378, y: 345, width: 11, height: 17 }),
      Stem16: tx({ id: "Foliage.Stem16", atlas: 0, x: 1010, y: 137, width: 14, height: 16 }),
      ...
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 1010, y: 154, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      Aquarium: {
        ...
        Coral: tx({ id: "Furniture.Aquarium.Coral", atlas: 0, x: 271, y: 459, width: 28, height: 26 }),
    ...
    Iguana: {
      Boiled: {
        ...
        Eye: tx({ id: "Iguana.Boiled.Eye", atlas: 0, x: 663, y: 469, width: 12, height: 12 }),
        ...
        Nails: tx({ id: "Iguana.Boiled.Nails", atlas: 0, x: 271, y: 449, width: 45, height: 9 }),
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 676, y: 469, width: 12, height: 12 }),
    ...
    Light: {
      ...
      ShadowIguana: tx({ id: "Light.ShadowIguana", atlas: 0, x: 393, y: 438, width: 48, height: 10 }),
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 689, y: 469, width: 12, height: 10 }),
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 832, y: 449, width: 16, height: 8 }),
    },
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 300, y: 476, width: 14, height: 14 }),
    Shapes: {
      ...
      Confetti18x8: tx({ id: "Shapes.Confetti18x8", atlas: 0, x: 757, y: 362, width: 18, height: 8 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 720, y: 451, width: 16, height: 16 }),
      ...
      Zigzag14: tx({ id: "Shapes.Zigzag14", atlas: 0, x: 832, y: 458, width: 14, height: 8 }),
    },
    Sky: {
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 702, y: 478, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 702, y: 465, width: 14, height: 12 }),
        ...
        FishmongerBomb: tx({ id: "Town.Ball.FishmongerBomb", atlas: 0, x: 194, y: 357, width: 52, height: 28 }),
      ...
      Colossus: {
        ...
        Pupil0: tx({ id: "Town.Colossus.Pupil0", atlas: 0, x: 616, y: 428, width: 8, height: 16 }),
    ...
    Ui: {
      ...
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 695, y: 433, width: 8, height: 8 }),
