...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 809, y: 67, width: 48, height: 8 }),
    ...
    Iguana: {
      Club: tx({ id: "Iguana.Club", atlas: 0, x: 760, y: 67, width: 48, height: 12 }),
      ...
      Horn: tx({ id: "Iguana.Horn", atlas: 0, x: 711, y: 60, width: 48, height: 8 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 889, y: 73, width: 24, height: 24 }),
    },
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 809, y: 76, width: 30, height: 32 }),
    OpenDoor: tx({ id: "OpenDoor", atlas: 0, x: 858, y: 67, width: 30, height: 32 }),
    ...
    Terrain: {
      Pipe: {
        Gray: tx({ id: "Terrain.Pipe.Gray", atlas: 0, x: 1023, y: 0, width: 1, height: 9 }),
      },
    },
    Ui: {
      ...
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 1011, y: 7, width: 8, height: 8 }),
