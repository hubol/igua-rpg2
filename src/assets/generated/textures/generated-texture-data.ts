...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Collectibles: {
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 962, y: 78, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 743, y: 60, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 943, y: 89, width: 17, height: 13 }),
    },
    Effects: {
      WaterDripSmall: tx({ id: "Effects.WaterDripSmall", atlas: 0, x: 1023, y: 19, width: 1, height: 2 }),
    },
    Enemy: {
    ...
    Iguana: {
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 914, y: 99, width: 8, height: 8 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 765, y: 31, width: 140, height: 12 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 924, y: 74, width: 18, height: 18 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 899, y: 74, width: 24, height: 24 }),
    },
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 837, y: 67, width: 30, height: 32 }),
    Metal: {
      PipeDarkBroken: tx({ id: "Metal.PipeDarkBroken", atlas: 0, x: 782, y: 76, width: 4, height: 12 }),
    },
    OpenDoor: tx({ id: "OpenDoor", atlas: 0, x: 868, y: 67, width: 30, height: 32 }),
    ...
    Pottery: {
      ...
      BodyRed: tx({ id: "Pottery.BodyRed", atlas: 0, x: 1009, y: 43, width: 14, height: 4 }),
      BodyYellow: tx({ id: "Pottery.BodyYellow", atlas: 0, x: 1003, y: 56, width: 20, height: 4 }),
      HangerTriangle: tx({ id: "Pottery.HangerTriangle", atlas: 0, x: 924, y: 93, width: 14, height: 14 }),
      HeadGreen: tx({ id: "Pottery.HeadGreen", atlas: 0, x: 899, y: 99, width: 14, height: 8 }),
      HeadRed: tx({ id: "Pottery.HeadRed", atlas: 0, x: 980, y: 78, width: 14, height: 8 }),
      HeadYellow: tx({ id: "Pottery.HeadYellow", atlas: 0, x: 995, y: 78, width: 14, height: 8 }),
      PlantBushRed: tx({ id: "Pottery.PlantBushRed", atlas: 0, x: 943, y: 78, width: 18, height: 10 }),
      PlantReed: tx({ id: "Pottery.PlantReed", atlas: 0, x: 1013, y: 26, width: 10, height: 16 }),
    },
    Stone: {
    ...
    Terrain: {
      Pipe: {
        Gray: tx({ id: "Terrain.Pipe.Gray", atlas: 0, x: 1009, y: 31, width: 1, height: 9 }),
      },
    },
    Ui: {
      ...
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 782, y: 89, width: 8, height: 8 }),
      PlacementReticle: tx({ id: "Ui.PlacementReticle", atlas: 0, x: 899, y: 67, width: 6, height: 6 }),
    },
    Wood: {
