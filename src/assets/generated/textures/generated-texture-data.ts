...
const atlases = [{ url: require("./atlas0.png"), texturesCount: 223 }];
...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      BallFruitTypeA: tx({ id: "Collectibles.BallFruitTypeA", atlas: 0, x: 160, y: 721, width: 22, height: 20 }),
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 183, y: 721, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 334, y: 620, width: 8, height: 8 }),
      ComputerChip: tx({ id: "Collectibles.ComputerChip", atlas: 0, x: 206, y: 737, width: 22, height: 20 }),
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 64, y: 758, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 1017, y: 384, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 82, y: 770, width: 17, height: 13 }),
    },
    Door: {
    ...
    Effects: {
      ...
      BoomText: tx({ id: "Effects.BoomText", atlas: 0, x: 51, y: 679, width: 44, height: 16 }),
      Bubble4: tx({ id: "Effects.Bubble4", atlas: 0, x: 274, y: 734, width: 4, height: 4 }),
      ...
      Star12px: tx({ id: "Effects.Star12px", atlas: 0, x: 887, y: 588, width: 12, height: 10 }),
    ...
    Enemy: {
      ...
      SpikeBall: tx({ id: "Enemy.SpikeBall", atlas: 0, x: 492, y: 690, width: 24, height: 20 }),
      Suggestive: {
        ...
        Face: tx({ id: "Enemy.Suggestive.Face", atlas: 0, x: 315, y: 660, width: 38, height: 24 }),
    ...
    Esoteric: {
      Decoration: {
        ...
        SeedBag: tx({ id: "Esoteric.Decoration.SeedBag", atlas: 0, x: 484, y: 658, width: 32, height: 31 }),
      },
      Message: {
    ...
    Fiber: {
      RopeFrame: tx({ id: "Fiber.RopeFrame", atlas: 0, x: 447, y: 606, width: 37, height: 28 }),
    },
    Foliage: {
      BranchCut0: tx({ id: "Foliage.BranchCut0", atlas: 0, x: 135, y: 699, width: 24, height: 14 }),
      Bush0: tx({ id: "Foliage.Bush0", atlas: 0, x: 45, y: 696, width: 44, height: 24 }),
      ...
      Flower22: tx({ id: "Foliage.Flower22", atlas: 0, x: 86, y: 734, width: 22, height: 16 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 0, y: 760, width: 16, height: 16 }),
      Leaf36: tx({ id: "Foliage.Leaf36", atlas: 0, x: 208, y: 714, width: 36, height: 22 }),
      LeavesMedium0: tx({ id: "Foliage.LeavesMedium0", atlas: 0, x: 418, y: 463, width: 42, height: 60 }),
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 282, y: 707, width: 26, height: 31 }),
      Moss0: tx({ id: "Foliage.Moss0", atlas: 0, x: 430, y: 647, width: 16, height: 18 }),
      ...
      Small: tx({ id: "Foliage.Small", atlas: 0, x: 393, y: 629, width: 11, height: 17 }),
      Stem16: tx({ id: "Foliage.Stem16", atlas: 0, x: 403, y: 707, width: 14, height: 16 }),
      ...
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 126, y: 611, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      Aquarium: {
        ...
        Coral: tx({ id: "Furniture.Aquarium.Coral", atlas: 0, x: 97, y: 669, width: 28, height: 26 }),
        ...
        WaterIntake: tx({ id: "Furniture.Aquarium.WaterIntake", atlas: 0, x: 109, y: 734, width: 22, height: 14 }),
      },
      ...
      Doll0: tx({ id: "Furniture.Doll0", atlas: 0, x: 245, y: 734, width: 28, height: 30 }),
      Library: {
        Books0: tx({ id: "Furniture.Library.Books0", atlas: 0, x: 161, y: 652, width: 12, height: 14 }),
        Books1: tx({ id: "Furniture.Library.Books1", atlas: 0, x: 757, y: 561, width: 16, height: 12 }),
        Books2: tx({ id: "Furniture.Library.Books2", atlas: 0, x: 403, y: 724, width: 14, height: 16 }),
      },
      Pottery18: tx({ id: "Furniture.Pottery18", atlas: 0, x: 66, y: 739, width: 18, height: 18 }),
      Table0: tx({ id: "Furniture.Table0", atlas: 0, x: 219, y: 560, width: 62, height: 22 }),
      WateringCan: tx({ id: "Furniture.WateringCan", atlas: 0, x: 354, y: 670, width: 34, height: 22 }),
    },
    Iguana: {
      Boiled: {
        ...
        Eye: tx({ id: "Iguana.Boiled.Eye", atlas: 0, x: 375, y: 693, width: 12, height: 12 }),
        Foot: tx({ id: "Iguana.Boiled.Foot", atlas: 0, x: 681, y: 311, width: 210, height: 18 }),
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 375, y: 707, width: 27, height: 27 }),
        ...
        Torso: tx({ id: "Iguana.Boiled.Torso", atlas: 0, x: 485, y: 606, width: 36, height: 36 }),
      },
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 126, y: 627, width: 12, height: 12 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 468, y: 417, width: 210, height: 18 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 338, y: 722, width: 27, height: 27 }),
      ...
      Nails: tx({ id: "Iguana.Nails", atlas: 0, x: 51, y: 669, width: 45, height: 9 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 447, y: 635, width: 36, height: 36 }),
    },
    Light: {
      AuraIrregular40: tx({ id: "Light.AuraIrregular40", atlas: 0, x: 0, y: 717, width: 44, height: 42 }),
      ShadowIguana: tx({ id: "Light.ShadowIguana", atlas: 0, x: 126, y: 641, width: 48, height: 10 }),
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 1006, y: 328, width: 12, height: 10 }),
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 1007, y: 639, width: 16, height: 8 }),
    },
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 447, y: 705, width: 14, height: 14 }),
    Shapes: {
      Arc24: tx({ id: "Shapes.Arc24", atlas: 0, x: 522, y: 638, width: 24, height: 4 }),
      ...
      Confetti45deg: tx({ id: "Shapes.Confetti45deg", atlas: 0, x: 309, y: 737, width: 26, height: 26 }),
      Confetti18x8: tx({ id: "Shapes.Confetti18x8", atlas: 0, x: 315, y: 620, width: 18, height: 8 }),
      Confetti32: tx({ id: "Shapes.Confetti32", atlas: 0, x: 517, y: 674, width: 32, height: 32 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 17, y: 760, width: 16, height: 16 }),
      ...
      RightTriangle24px: tx({ id: "Shapes.RightTriangle24px", atlas: 0, x: 135, y: 714, width: 24, height: 22 }),
      SquareIrregular10: tx({ id: "Shapes.SquareIrregular10", atlas: 0, x: 1014, y: 532, width: 10, height: 10 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 430, y: 672, width: 32, height: 32 }),
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 34, y: 760, width: 10, height: 10 }),
      X22: tx({ id: "Shapes.X22", atlas: 0, x: 132, y: 737, width: 22, height: 16 }),
      Zigzag14: tx({ id: "Shapes.Zigzag14", atlas: 0, x: 293, y: 755, width: 14, height: 8 }),
    },
    Sky: {
    ...
    Stone: {
      ...
      RockLargeShaded: tx({ id: "Stone.RockLargeShaded", atlas: 0, x: 245, y: 668, width: 38, height: 26 }),
      RockSmallShaded1: tx({ id: "Stone.RockSmallShaded1", atlas: 0, x: 345, y: 560, width: 7, height: 6 }),
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 274, y: 739, width: 24, height: 15 }),
    ...
    Terrain: {
      Earth: {
        ...
        Crack8px12px: tx({ id: "Terrain.Earth.Crack8px12px", atlas: 0, x: 100, y: 770, width: 8, height: 12 }),
        Crack28px38px: tx({ id: "Terrain.Earth.Crack28px38px", atlas: 0, x: 284, y: 668, width: 28, height: 38 }),
        CrackSmall0: tx({ id: "Terrain.Earth.CrackSmall0", atlas: 0, x: 547, y: 638, width: 8, height: 4 }),
        ExposedDirt: tx({ id: "Terrain.Earth.ExposedDirt", atlas: 0, x: 931, y: 51, width: 80, height: 14 }),
        Loop: tx({ id: "Terrain.Earth.Loop", atlas: 0, x: 85, y: 751, width: 17, height: 18 }),
        ...
        V: tx({ id: "Terrain.Earth.V", atlas: 0, x: 45, y: 739, width: 20, height: 18 }),
      ...
      Grass: {
        Jagged2px: tx({ id: "Terrain.Grass.Jagged2px", atlas: 0, x: 45, y: 721, width: 42, height: 8 }),
        ...
        Shape1: tx({ id: "Terrain.Grass.Shape1", atlas: 0, x: 45, y: 730, width: 40, height: 8 }),
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 161, y: 667, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 229, y: 737, width: 14, height: 12 }),
        Brick0: tx({ id: "Town.Ball.Brick0", atlas: 0, x: 393, y: 647, width: 36, height: 30 }),
        ...
        StructureHighlight: tx({ id: "Town.Ball.StructureHighlight", atlas: 0, x: 406, y: 606, width: 40, height: 40 }),
        ...
        Symbols: {
          Circle: tx({ id: "Town.Ball.Symbols.Circle", atlas: 0, x: 389, y: 678, width: 28, height: 28 }),
          P: tx({ id: "Town.Ball.Symbols.P", atlas: 0, x: 348, y: 693, width: 26, height: 28 }),
          Square: tx({ id: "Town.Ball.Symbols.Square", atlas: 0, x: 313, y: 685, width: 34, height: 30 }),
          Star: tx({ id: "Town.Ball.Symbols.Star", atlas: 0, x: 315, y: 629, width: 40, height: 30 }),
        },
      },
      Colossus: {
        Eyebrow0: tx({ id: "Town.Colossus.Eyebrow0", atlas: 0, x: 315, y: 611, width: 26, height: 8 }),
        Eyebrow1: tx({ id: "Town.Colossus.Eyebrow1", atlas: 0, x: 522, y: 623, width: 26, height: 14 }),
        Eyelid0: tx({ id: "Town.Colossus.Eyelid0", atlas: 0, x: 463, y: 672, width: 20, height: 14 }),
        ...
        Nose0: tx({ id: "Town.Colossus.Nose0", atlas: 0, x: 45, y: 758, width: 18, height: 12 }),
        Pupil0: tx({ id: "Town.Colossus.Pupil0", atlas: 0, x: 366, y: 722, width: 8, height: 16 }),
        Pupil1: tx({ id: "Town.Colossus.Pupil1", atlas: 0, x: 484, y: 643, width: 34, height: 14 }),
        Pupil2: tx({ id: "Town.Colossus.Pupil2", atlas: 0, x: 229, y: 750, width: 12, height: 12 }),
        Sclera0: tx({ id: "Town.Colossus.Sclera0", atlas: 0, x: 274, y: 755, width: 18, height: 24 }),
        Sclera1: tx({ id: "Town.Colossus.Sclera1", atlas: 0, x: 219, y: 583, width: 60, height: 36 }),
        Sclera2: tx({ id: "Town.Colossus.Sclera2", atlas: 0, x: 356, y: 629, width: 36, height: 40 }),
        Tooth0: tx({ id: "Town.Colossus.Tooth0", atlas: 0, x: 981, y: 228, width: 4, height: 18 }),
      },
      Monument: {
      ...
      Underneath: {
        ...
        RiserFaceHappy: tx({ id: "Town.Underneath.RiserFaceHappy", atlas: 0, x: 309, y: 716, width: 28, height: 20 }),
        RiserFaceSurprise: tx({ id: "Town.Underneath.RiserFaceSurprise", atlas: 0, x: 463, y: 690, width: 28, height: 20 }),
        RiserFace: tx({ id: "Town.Underneath.RiserFace", atlas: 0, x: 418, y: 705, width: 28, height: 20 }),
      },
    },
    Ui: {
      ...
      InteractionIndicator: tx({ id: "Ui.InteractionIndicator", atlas: 0, x: 109, y: 749, width: 22, height: 22 }),
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 1016, y: 702, width: 8, height: 8 }),
      PlacementReticle: tx({ id: "Ui.PlacementReticle", atlas: 0, x: 1018, y: 254, width: 6, height: 6 }),
      Pocket: {
    ...
    Wood: {
      ...
      Crate0: tx({ id: "Wood.Crate0", atlas: 0, x: 519, y: 643, width: 34, height: 30 }),
