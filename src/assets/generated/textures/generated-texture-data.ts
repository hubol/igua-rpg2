...
const atlases = [{ url: require("./atlas0.png"), texturesCount: 212 }];
...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      BallFruitTypeA: tx({ id: "Collectibles.BallFruitTypeA", atlas: 0, x: 1002, y: 682, width: 22, height: 20 }),
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 974, y: 742, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 1007, y: 15, width: 8, height: 8 }),
      ComputerChip: tx({ id: "Collectibles.ComputerChip", atlas: 0, x: 138, y: 464, width: 22, height: 20 }),
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 138, y: 485, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 926, y: 542, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 104, y: 570, width: 17, height: 13 }),
    },
    Door: {
      NormalLockedLayer0: tx({ id: "Door.NormalLockedLayer0", atlas: 0, x: 549, y: 572, width: 34, height: 46 }),
      NormalLockedLayer1: tx({ id: "Door.NormalLockedLayer1", atlas: 0, x: 975, y: 580, width: 34, height: 46 }),
      NormalLockedLayer2: tx({ id: "Door.NormalLockedLayer2", atlas: 0, x: 926, y: 582, width: 34, height: 46 }),
    ...
    Effects: {
      ...
      Bubble4: tx({ id: "Effects.Bubble4", atlas: 0, x: 406, y: 509, width: 4, height: 4 }),
      Burst32: tx({ id: "Effects.Burst32", atlas: 0, x: 991, y: 659, width: 32, height: 22 }),
      ...
      Star12px: tx({ id: "Effects.Star12px", atlas: 0, x: 1002, y: 703, width: 12, height: 10 }),
      ValuableSparkle: tx({ id: "Effects.ValuableSparkle", atlas: 0, x: 973, y: 379, width: 35, height: 7 }),
    ...
    Enemy: {
      ...
      SpikeBall: tx({ id: "Enemy.SpikeBall", atlas: 0, x: 997, y: 741, width: 24, height: 20 }),
      Suggestive: {
        ...
        Face: tx({ id: "Enemy.Suggestive.Face", atlas: 0, x: 65, y: 551, width: 38, height: 24 }),
        Gear: tx({ id: "Enemy.Suggestive.Gear", atlas: 0, x: 936, y: 675, width: 32, height: 16 }),
        Mouth: tx({ id: "Enemy.Suggestive.Mouth", atlas: 0, x: 991, y: 652, width: 33, height: 6 }),
        Pupil: tx({ id: "Enemy.Suggestive.Pupil", atlas: 0, x: 1022, y: 412, width: 2, height: 8 }),
        ScleraWide: tx({ id: "Enemy.Suggestive.ScleraWide", atlas: 0, x: 969, y: 675, width: 14, height: 6 }),
    ...
    Esoteric: {
      Decoration: {
        Bandage: tx({ id: "Esoteric.Decoration.Bandage", atlas: 0, x: 961, y: 582, width: 12, height: 26 }),
        PicaxeGiant: tx({ id: "Esoteric.Decoration.PicaxeGiant", atlas: 0, x: 934, y: 487, width: 72, height: 69 }),
        SeedBag: tx({ id: "Esoteric.Decoration.SeedBag", atlas: 0, x: 969, y: 682, width: 32, height: 31 }),
      },
      Message: {
    ...
    Fiber: {
      RopeFrame: tx({ id: "Fiber.RopeFrame", atlas: 0, x: 0, y: 586, width: 37, height: 28 }),
    },
    Foliage: {
      BranchCut0: tx({ id: "Foliage.BranchCut0", atlas: 0, x: 160, y: 543, width: 24, height: 14 }),
      Bush0: tx({ id: "Foliage.Bush0", atlas: 0, x: 961, y: 627, width: 44, height: 24 }),
      Flower14: tx({ id: "Foliage.Flower14", atlas: 0, x: 1010, y: 614, width: 14, height: 8 }),
      Flower18: tx({ id: "Foliage.Flower18", atlas: 0, x: 689, y: 466, width: 18, height: 10 }),
      Flower22: tx({ id: "Foliage.Flower22", atlas: 0, x: 997, y: 762, width: 22, height: 16 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 949, y: 725, width: 16, height: 16 }),
      Leaf36: tx({ id: "Foliage.Leaf36", atlas: 0, x: 954, y: 652, width: 36, height: 22 }),
      LeavesMedium0: tx({ id: "Foliage.LeavesMedium0", atlas: 0, x: 883, y: 542, width: 42, height: 60 }),
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 38, y: 586, width: 26, height: 31 }),
      ...
      RootMedium0: tx({ id: "Foliage.RootMedium0", atlas: 0, x: 926, y: 557, width: 48, height: 19 }),
      Small: tx({ id: "Foliage.Small", atlas: 0, x: 290, y: 499, width: 11, height: 17 }),
      Stem16: tx({ id: "Foliage.Stem16", atlas: 0, x: 1010, y: 580, width: 14, height: 16 }),
      TallRoundRed: tx({ id: "Foliage.TallRoundRed", atlas: 0, x: 986, y: 114, width: 35, height: 88 }),
      TreeRingExposed: tx({ id: "Foliage.TreeRingExposed", atlas: 0, x: 975, y: 557, width: 48, height: 22 }),
      Vine0: tx({ id: "Foliage.Vine0", atlas: 0, x: 161, y: 369, width: 6, height: 33 }),
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 485, y: 344, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      Aquarium: {
        ...
        Coral: tx({ id: "Furniture.Aquarium.Coral", atlas: 0, x: 0, y: 615, width: 28, height: 26 }),
        ...
        WaterIntake: tx({ id: "Furniture.Aquarium.WaterIntake", atlas: 0, x: 286, y: 552, width: 22, height: 14 }),
      },
      ...
      Library: {
        Books0: tx({ id: "Furniture.Library.Books0", atlas: 0, x: 961, y: 609, width: 12, height: 14 }),
        Books1: tx({ id: "Furniture.Library.Books1", atlas: 0, x: 1007, y: 506, width: 16, height: 12 }),
        Books2: tx({ id: "Furniture.Library.Books2", atlas: 0, x: 1010, y: 597, width: 14, height: 16 }),
      },
      Pottery18: tx({ id: "Furniture.Pottery18", atlas: 0, x: 104, y: 551, width: 18, height: 18 }),
    ...
    Iguana: {
      Boiled: {
        ...
        Eye: tx({ id: "Iguana.Boiled.Eye", atlas: 0, x: 272, y: 563, width: 12, height: 12 }),
        Foot: tx({ id: "Iguana.Boiled.Foot", atlas: 0, x: 681, y: 215, width: 210, height: 18 }),
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 0, y: 642, width: 27, height: 27 }),
        ...
        Torso: tx({ id: "Iguana.Boiled.Torso", atlas: 0, x: 899, y: 672, width: 36, height: 36 }),
      },
      ...
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 969, y: 714, width: 27, height: 27 }),
    ...
    Light: {
      AuraIrregular40: tx({ id: "Light.AuraIrregular40", atlas: 0, x: 909, y: 629, width: 44, height: 42 }),
      ShadowIguana: tx({ id: "Light.ShadowIguana", atlas: 0, x: 843, y: 268, width: 48, height: 10 }),
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 708, y: 466, width: 12, height: 10 }),
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 1007, y: 519, width: 16, height: 8 }),
    },
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 485, y: 360, width: 14, height: 14 }),
    Shapes: {
      ...
      Confetti45deg: tx({ id: "Shapes.Confetti45deg", atlas: 0, x: 997, y: 714, width: 26, height: 26 }),
      Confetti18x8: tx({ id: "Shapes.Confetti18x8", atlas: 0, x: 466, y: 459, width: 18, height: 8 }),
      Confetti32: tx({ id: "Shapes.Confetti32", atlas: 0, x: 936, y: 692, width: 32, height: 32 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 1007, y: 528, width: 16, height: 16 }),
      ...
      RightTriangle24px: tx({ id: "Shapes.RightTriangle24px", atlas: 0, x: 924, y: 725, width: 24, height: 22 }),
      SquareIrregular10: tx({ id: "Shapes.SquareIrregular10", atlas: 0, x: 177, y: 558, width: 10, height: 10 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 891, y: 709, width: 32, height: 32 }),
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 298, y: 567, width: 10, height: 10 }),
      X22: tx({ id: "Shapes.X22", atlas: 0, x: 249, y: 563, width: 22, height: 16 }),
      Zigzag14: tx({ id: "Shapes.Zigzag14", atlas: 0, x: 594, y: 455, width: 14, height: 8 }),
    },
    Sky: {
    ...
    Stone: {
      ...
      BrickSingle0: tx({ id: "Stone.BrickSingle0", atlas: 0, x: 160, y: 558, width: 16, height: 10 }),
      RockLargeShaded: tx({ id: "Stone.RockLargeShaded", atlas: 0, x: 65, y: 576, width: 38, height: 26 }),
      RockSmallShaded1: tx({ id: "Stone.RockSmallShaded1", atlas: 0, x: 901, y: 650, width: 7, height: 6 }),
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 949, y: 742, width: 24, height: 15 }),
    ...
    Terrain: {
      Earth: {
        ...
        CrackSmall0: tx({ id: "Terrain.Earth.CrackSmall0", atlas: 0, x: 56, y: 618, width: 8, height: 4 }),
        ...
        V: tx({ id: "Terrain.Earth.V", atlas: 0, x: 139, y: 584, width: 20, height: 18 }),
      ...
      Grass: {
        ...
        Sparse3px: tx({ id: "Terrain.Grass.Sparse3px", atlas: 0, x: 926, y: 577, width: 48, height: 4 }),
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 485, y: 401, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 485, y: 375, width: 14, height: 12 }),
        ...
        Dice: tx({ id: "Town.Ball.Dice", atlas: 0, x: 992, y: 203, width: 10, height: 10 }),
        ...
        Symbols: {
          Circle: tx({ id: "Town.Ball.Symbols.Circle", atlas: 0, x: 65, y: 603, width: 28, height: 28 }),
          P: tx({ id: "Town.Ball.Symbols.P", atlas: 0, x: 29, y: 618, width: 26, height: 28 }),
          Square: tx({ id: "Town.Ball.Symbols.Square", atlas: 0, x: 160, y: 569, width: 34, height: 30 }),
      ...
      Colossus: {
        ...
        Eyebrow1: tx({ id: "Town.Colossus.Eyebrow1", atlas: 0, x: 379, y: 509, width: 26, height: 14 }),
        ...
        Mouth2: tx({ id: "Town.Colossus.Mouth2", atlas: 0, x: 973, y: 334, width: 50, height: 14 }),
        Noggin0: tx({ id: "Town.Colossus.Noggin0", atlas: 0, x: 502, y: 533, width: 84, height: 38 }),
        Nose0: tx({ id: "Town.Colossus.Nose0", atlas: 0, x: 1006, y: 627, width: 18, height: 12 }),
        Pupil0: tx({ id: "Town.Colossus.Pupil0", atlas: 0, x: 874, y: 561, width: 8, height: 16 }),
        Pupil1: tx({ id: "Town.Colossus.Pupil1", atlas: 0, x: 104, y: 584, width: 34, height: 14 }),
        Pupil2: tx({ id: "Town.Colossus.Pupil2", atlas: 0, x: 285, y: 567, width: 12, height: 12 }),
        Sclera0: tx({ id: "Town.Colossus.Sclera0", atlas: 0, x: 195, y: 569, width: 18, height: 24 }),
        Sclera1: tx({ id: "Town.Colossus.Sclera1", atlas: 0, x: 813, y: 561, width: 60, height: 36 }),
        Sclera2: tx({ id: "Town.Colossus.Sclera2", atlas: 0, x: 123, y: 543, width: 36, height: 40 }),
    ...
    Ui: {
      ...
      InteractionIndicator: tx({ id: "Ui.InteractionIndicator", atlas: 0, x: 309, y: 552, width: 22, height: 22 }),
    ...
    Wood: {
      ...
      Crate0: tx({ id: "Wood.Crate0", atlas: 0, x: 104, y: 599, width: 34, height: 30 }),
      MeasuringStick: tx({ id: "Wood.MeasuringStick", atlas: 0, x: 804, y: 560, width: 8, height: 64 }),
      Sign: tx({ id: "Wood.Sign", atlas: 0, x: 973, y: 349, width: 50, height: 29 }),
    },
  };
}
