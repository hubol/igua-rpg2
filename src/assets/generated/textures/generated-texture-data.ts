...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      BallFruitTypeA: tx({ id: "Collectibles.BallFruitTypeA", atlas: 0, x: 309, y: 737, width: 22, height: 20 }),
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 274, y: 739, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 334, y: 620, width: 8, height: 8 }),
      ComputerChip: tx({ id: "Collectibles.ComputerChip", atlas: 0, x: 446, y: 718, width: 22, height: 20 }),
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 355, y: 749, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 1017, y: 384, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 398, y: 750, width: 17, height: 13 }),
    },
    Door: {
    ...
    Foliage: {
      BranchCut0: tx({ id: "Foliage.BranchCut0", atlas: 0, x: 491, y: 690, width: 24, height: 14 }),
      Bush0: tx({ id: "Foliage.Bush0", atlas: 0, x: 45, y: 696, width: 44, height: 24 }),
      Flower14: tx({ id: "Foliage.Flower14", atlas: 0, x: 402, y: 724, width: 14, height: 8 }),
      Flower18: tx({ id: "Foliage.Flower18", atlas: 0, x: 1006, y: 317, width: 18, height: 10 }),
      Flower22: tx({ id: "Foliage.Flower22", atlas: 0, x: 402, y: 733, width: 22, height: 16 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 373, y: 753, width: 16, height: 16 }),
      ...
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 390, y: 764, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      Aquarium: {
        ...
        WaterIntake: tx({ id: "Furniture.Aquarium.WaterIntake", atlas: 0, x: 357, y: 734, width: 22, height: 14 }),
      },
      ...
      Library: {
        ...
        Books2: tx({ id: "Furniture.Library.Books2", atlas: 0, x: 402, y: 707, width: 14, height: 16 }),
      },
      Pottery18: tx({ id: "Furniture.Pottery18", atlas: 0, x: 469, y: 718, width: 18, height: 18 }),
    ...
    Iguana: {
      Boiled: {
        ...
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 463, y: 690, width: 27, height: 27 }),
      ...
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 418, y: 705, width: 27, height: 27 }),
    ...
    Light: {
      ...
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 1001, y: 254, width: 12, height: 10 }),
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 446, y: 705, width: 16, height: 8 }),
    },
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 372, y: 770, width: 14, height: 14 }),
    Shapes: {
      ...
      Confetti45deg: tx({ id: "Shapes.Confetti45deg", atlas: 0, x: 375, y: 707, width: 26, height: 26 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 355, y: 763, width: 16, height: 16 }),
      ...
      RightTriangle24px: tx({ id: "Shapes.RightTriangle24px", atlas: 0, x: 135, y: 720, width: 24, height: 22 }),
      ...
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 405, y: 764, width: 10, height: 10 }),
      X22: tx({ id: "Shapes.X22", atlas: 0, x: 332, y: 747, width: 22, height: 16 }),
      Zigzag14: tx({ id: "Shapes.Zigzag14", atlas: 0, x: 852, y: 459, width: 14, height: 8 }),
    },
    Sky: {
    ...
    Stone: {
      ...
      BrickSingle0: tx({ id: "Stone.BrickSingle0", atlas: 0, x: 1007, y: 639, width: 16, height: 10 }),
      ...
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 491, y: 705, width: 24, height: 15 }),
    ...
    Terrain: {
      Earth: {
        ...
        Loop: tx({ id: "Terrain.Earth.Loop", atlas: 0, x: 380, y: 734, width: 17, height: 18 }),
        ...
        V: tx({ id: "Terrain.Earth.V", atlas: 0, x: 425, y: 733, width: 20, height: 18 }),
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 320, y: 764, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 126, y: 628, width: 14, height: 12 }),
      ...
      Colossus: {
        ...
        Nose0: tx({ id: "Town.Colossus.Nose0", atlas: 0, x: 274, y: 760, width: 18, height: 12 }),
        Pupil0: tx({ id: "Town.Colossus.Pupil0", atlas: 0, x: 416, y: 750, width: 8, height: 16 }),
        Pupil1: tx({ id: "Town.Colossus.Pupil1", atlas: 0, x: 484, y: 643, width: 34, height: 14 }),
        Pupil2: tx({ id: "Town.Colossus.Pupil2", atlas: 0, x: 333, y: 764, width: 12, height: 12 }),
        Sclera0: tx({ id: "Town.Colossus.Sclera0", atlas: 0, x: 338, y: 722, width: 18, height: 24 }),
