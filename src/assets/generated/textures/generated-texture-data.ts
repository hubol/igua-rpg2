...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 711, y: 60, width: 48, height: 8 }),
    ...
    Iguana: {
      ...
      Horn: tx({ id: "Iguana.Horn", atlas: 0, x: 809, y: 67, width: 48, height: 8 }),
    ...
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 858, y: 67, width: 30, height: 32 }),
    OpenDoor: tx({ id: "OpenDoor", atlas: 0, x: 809, y: 76, width: 30, height: 32 }),
