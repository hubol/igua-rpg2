...
const atlases = [{ url: require("./atlas0.png"), texturesCount: 219 }];
...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      BallFruitTypeA: tx({ id: "Collectibles.BallFruitTypeA", atlas: 0, x: 375, y: 707, width: 22, height: 20 }),
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 337, y: 722, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 1016, y: 732, width: 8, height: 8 }),
      ComputerChip: tx({ id: "Collectibles.ComputerChip", atlas: 0, x: 160, y: 721, width: 22, height: 20 }),
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 417, y: 728, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 1017, y: 384, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 245, y: 765, width: 17, height: 13 }),
    },
    Door: {
    ...
    Enemy: {
      ...
      SpikeBall: tx({ id: "Enemy.SpikeBall", atlas: 0, x: 135, y: 699, width: 24, height: 20 }),
      Suggestive: {
    ...
    Foliage: {
      BranchCut0: tx({ id: "Foliage.BranchCut0", atlas: 0, x: 135, y: 720, width: 24, height: 14 }),
      ...
      Flower22: tx({ id: "Foliage.Flower22", atlas: 0, x: 183, y: 721, width: 22, height: 16 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 360, y: 728, width: 16, height: 16 }),
      ...
      Stem16: tx({ id: "Foliage.Stem16", atlas: 0, x: 229, y: 737, width: 14, height: 16 }),
      ...
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 337, y: 743, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      Aquarium: {
        ...
        WaterIntake: tx({ id: "Furniture.Aquarium.WaterIntake", atlas: 0, x: 522, y: 623, width: 22, height: 14 }),
      },
      ...
      Library: {
        ...
        Books2: tx({ id: "Furniture.Library.Books2", atlas: 0, x: 126, y: 611, width: 14, height: 16 }),
      },
      Pottery18: tx({ id: "Furniture.Pottery18", atlas: 0, x: 398, y: 707, width: 18, height: 18 }),
    ...
    Iguana: {
      Boiled: {
        ...
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 309, y: 716, width: 27, height: 27 }),
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 161, y: 667, width: 12, height: 12 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 468, y: 417, width: 210, height: 18 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 274, y: 739, width: 27, height: 27 }),
    ...
    Light: {
      ...
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 317, y: 744, width: 12, height: 10 }),
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 1007, y: 639, width: 16, height: 8 }),
    },
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 394, y: 739, width: 14, height: 14 }),
    Shapes: {
      ...
      Confetti45deg: tx({ id: "Shapes.Confetti45deg", atlas: 0, x: 463, y: 690, width: 26, height: 26 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 377, y: 728, width: 16, height: 16 }),
      ...
      RightTriangle24px: tx({ id: "Shapes.RightTriangle24px", atlas: 0, x: 418, y: 705, width: 24, height: 22 }),
      ...
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 545, y: 623, width: 10, height: 10 }),
      X22: tx({ id: "Shapes.X22", atlas: 0, x: 206, y: 737, width: 22, height: 16 }),
    ...
    Stone: {
      ...
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 315, y: 611, width: 24, height: 15 }),
    ...
    Terrain: {
      Earth: {
        ...
        Crack8px12px: tx({ id: "Terrain.Earth.Crack8px12px", atlas: 0, x: 1016, y: 719, width: 8, height: 12 }),
        Crack28px38px: tx({ id: "Terrain.Earth.Crack28px38px", atlas: 0, x: 284, y: 668, width: 28, height: 38 }),
        CrackSmall0: tx({ id: "Terrain.Earth.CrackSmall0", atlas: 0, x: 522, y: 638, width: 8, height: 4 }),
        ExposedDirt: tx({ id: "Terrain.Earth.ExposedDirt", atlas: 0, x: 931, y: 51, width: 80, height: 14 }),
        Loop: tx({ id: "Terrain.Earth.Loop", atlas: 0, x: 227, y: 754, width: 17, height: 18 }),
        Mass0: tx({ id: "Terrain.Earth.Mass0", atlas: 0, x: 418, y: 524, width: 137, height: 81 }),
        QuestionMark: tx({ id: "Terrain.Earth.QuestionMark", atlas: 0, x: 443, y: 705, width: 18, height: 24 }),
        ...
        V: tx({ id: "Terrain.Earth.V", atlas: 0, x: 206, y: 754, width: 20, height: 18 }),
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 317, y: 755, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 302, y: 744, width: 14, height: 12 }),
        ...
        Dice: tx({ id: "Town.Ball.Dice", atlas: 0, x: 263, y: 765, width: 10, height: 10 }),
      ...
      Colossus: {
        Eyebrow0: tx({ id: "Town.Colossus.Eyebrow0", atlas: 0, x: 490, y: 690, width: 26, height: 8 }),
        Eyebrow1: tx({ id: "Town.Colossus.Eyebrow1", atlas: 0, x: 490, y: 699, width: 26, height: 14 }),
        ...
        Nose0: tx({ id: "Town.Colossus.Nose0", atlas: 0, x: 398, y: 726, width: 18, height: 12 }),
        Pupil0: tx({ id: "Town.Colossus.Pupil0", atlas: 0, x: 1016, y: 702, width: 8, height: 16 }),
        Pupil1: tx({ id: "Town.Colossus.Pupil1", atlas: 0, x: 484, y: 643, width: 34, height: 14 }),
        Pupil2: tx({ id: "Town.Colossus.Pupil2", atlas: 0, x: 302, y: 757, width: 12, height: 12 }),
        Sclera0: tx({ id: "Town.Colossus.Sclera0", atlas: 0, x: 965, y: 203, width: 18, height: 24 }),
    ...
    Ui: {
      ...
      InteractionIndicator: tx({ id: "Ui.InteractionIndicator", atlas: 0, x: 183, y: 738, width: 22, height: 22 }),
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 545, y: 634, width: 8, height: 8 }),
