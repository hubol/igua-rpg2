...
const atlases = [{ url: require("./atlas0.png"), texturesCount: 175 }];
...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      BallFruitTypeA: tx({ id: "Collectibles.BallFruitTypeA", atlas: 0, x: 168, y: 471, width: 22, height: 20 }),
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 809, y: 449, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 728, y: 471, width: 8, height: 8 }),
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 615, y: 475, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 451, y: 376, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 702, y: 451, width: 17, height: 13 }),
    },
    Door: {
    ...
    Effects: {
      ...
      Burst32: tx({ id: "Effects.Burst32", atlas: 0, x: 704, y: 428, width: 32, height: 22 }),
      ...
      Star12px: tx({ id: "Effects.Star12px", atlas: 0, x: 720, y: 460, width: 12, height: 10 }),
      ...
      WaterDripXsmall: tx({ id: "Effects.WaterDripXsmall", atlas: 0, x: 243, y: 386, width: 3, height: 5 }),
    },
    Enemy: {
      CommonClown: tx({ id: "Enemy.CommonClown", atlas: 0, x: 835, y: 343, width: 44, height: 32 }),
      ...
      Suggestive: {
        ...
        Face: tx({ id: "Enemy.Suggestive.Face", atlas: 0, x: 666, y: 379, width: 38, height: 24 }),
        Gear: tx({ id: "Enemy.Suggestive.Gear", atlas: 0, x: 662, y: 433, width: 32, height: 16 }),
        ...
        Sclera: tx({ id: "Enemy.Suggestive.Sclera", atlas: 0, x: 616, y: 428, width: 8, height: 16 }),
    ...
    Esoteric: {
      Decoration: {
        ...
        SeedBag: tx({ id: "Esoteric.Decoration.SeedBag", atlas: 0, x: 816, y: 417, width: 32, height: 31 }),
      },
      Message: {
    ...
    Fiber: {
      RopeFrame: tx({ id: "Fiber.RopeFrame", atlas: 0, x: 666, y: 404, width: 37, height: 28 }),
    },
    Foliage: {
      Flower14: tx({ id: "Foliage.Flower14", atlas: 0, x: 774, y: 362, width: 14, height: 8 }),
      Flower18: tx({ id: "Foliage.Flower18", atlas: 0, x: 320, y: 449, width: 18, height: 10 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 300, y: 470, width: 16, height: 16 }),
      Leaf36: tx({ id: "Foliage.Leaf36", atlas: 0, x: 875, y: 382, width: 36, height: 22 }),
      LeavesMedium0: tx({ id: "Foliage.LeavesMedium0", atlas: 0, x: 516, y: 383, width: 42, height: 60 }),
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 317, y: 460, width: 26, height: 31 }),
      RootMedium0: tx({ id: "Foliage.RootMedium0", atlas: 0, x: 397, y: 438, width: 48, height: 19 }),
      Small: tx({ id: "Foliage.Small", atlas: 0, x: 378, y: 345, width: 11, height: 17 }),
      Stem16: tx({ id: "Foliage.Stem16", atlas: 0, x: 1010, y: 135, width: 14, height: 16 }),
      ...
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 1010, y: 152, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      Aquarium: {
        ...
        Coral: tx({ id: "Furniture.Aquarium.Coral", atlas: 0, x: 271, y: 470, width: 28, height: 26 }),
        ...
        WaterIntake: tx({ id: "Furniture.Aquarium.WaterIntake", atlas: 0, x: 770, y: 461, width: 22, height: 14 }),
      },
      ...
      Pottery18: tx({ id: "Furniture.Pottery18", atlas: 0, x: 665, y: 450, width: 18, height: 18 }),
      Table0: tx({ id: "Furniture.Table0", atlas: 0, x: 279, y: 394, width: 62, height: 22 }),
      WateringCan: tx({ id: "Furniture.WateringCan", atlas: 0, x: 781, y: 405, width: 34, height: 22 }),
    },
    Iguana: {
      Boiled: {
        ...
        Eye: tx({ id: "Iguana.Boiled.Eye", atlas: 0, x: 702, y: 465, width: 12, height: 12 }),
        Foot: tx({ id: "Iguana.Boiled.Foot", atlas: 0, x: 789, y: 171, width: 210, height: 18 }),
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 588, y: 428, width: 27, height: 27 }),
        ...
        Nails: tx({ id: "Iguana.Boiled.Nails", atlas: 0, x: 271, y: 460, width: 45, height: 9 }),
        ...
        Torso: tx({ id: "Iguana.Boiled.Torso", atlas: 0, x: 875, y: 405, width: 36, height: 36 }),
      },
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 715, y: 471, width: 12, height: 12 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 762, y: 271, width: 210, height: 18 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 616, y: 447, width: 27, height: 27 }),
      ...
      Nails: tx({ id: "Iguana.Nails", atlas: 0, x: 789, y: 343, width: 45, height: 9 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 625, y: 410, width: 36, height: 36 }),
    },
    Light: {
      AuraIrregular40: tx({ id: "Light.AuraIrregular40", atlas: 0, x: 789, y: 353, width: 44, height: 42 }),
      ShadowIguana: tx({ id: "Light.ShadowIguana", atlas: 0, x: 271, y: 449, width: 48, height: 10 }),
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 663, y: 469, width: 12, height: 10 }),
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 757, y: 362, width: 16, height: 8 }),
    },
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 793, y: 461, width: 14, height: 14 }),
    Shapes: {
      Arc24: tx({ id: "Shapes.Arc24", atlas: 0, x: 168, y: 450, width: 24, height: 4 }),
      ...
      Confetti45deg: tx({ id: "Shapes.Confetti45deg", atlas: 0, x: 588, y: 456, width: 26, height: 26 }),
      Confetti18x8: tx({ id: "Shapes.Confetti18x8", atlas: 0, x: 1006, y: 126, width: 18, height: 8 }),
      Confetti32: tx({ id: "Shapes.Confetti32", atlas: 0, x: 776, y: 428, width: 32, height: 32 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 832, y: 449, width: 16, height: 16 }),
      ...
      RightTriangle24px: tx({ id: "Shapes.RightTriangle24px", atlas: 0, x: 849, y: 417, width: 24, height: 22 }),
      SquareIrregular10: tx({ id: "Shapes.SquareIrregular10", atlas: 0, x: 577, y: 457, width: 10, height: 10 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 737, y: 442, width: 32, height: 32 }),
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 633, y: 475, width: 10, height: 10 }),
      X22: tx({ id: "Shapes.X22", atlas: 0, x: 510, y: 444, width: 22, height: 16 }),
      Zigzag14: tx({ id: "Shapes.Zigzag14", atlas: 0, x: 720, y: 451, width: 14, height: 8 }),
    },
    Sky: {
    ...
    Stone: {
      RockLargeShaded: tx({ id: "Stone.RockLargeShaded", atlas: 0, x: 705, y: 380, width: 38, height: 26 }),
      RockSmallShaded1: tx({ id: "Stone.RockSmallShaded1", atlas: 0, x: 161, y: 249, width: 7, height: 6 }),
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 168, y: 455, width: 24, height: 15 }),
    ...
    Terrain: {
      Earth: {
        ...
        Crack28px38px: tx({ id: "Terrain.Earth.Crack28px38px", atlas: 0, x: 880, y: 343, width: 28, height: 38 }),
        ...
        Loop: tx({ id: "Terrain.Earth.Loop", atlas: 0, x: 684, y: 450, width: 17, height: 18 }),
        ...
        V: tx({ id: "Terrain.Earth.V", atlas: 0, x: 556, y: 457, width: 20, height: 18 }),
        ValuableBlue0: tx({ id: "Terrain.Earth.ValuableBlue0", atlas: 0, x: 849, y: 440, width: 20, height: 24 }),
      ...
      Grass: {
        Jagged2px: tx({ id: "Terrain.Grass.Jagged2px", atlas: 0, x: 714, y: 362, width: 42, height: 8 }),
        ...
        Shape1: tx({ id: "Terrain.Grass.Shape1", atlas: 0, x: 714, y: 371, width: 40, height: 8 }),
        Sparse3px: tx({ id: "Terrain.Grass.Sparse3px", atlas: 0, x: 194, y: 386, width: 48, height: 4 }),
      },
      Pipe: {
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 676, y: 469, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 300, y: 487, width: 14, height: 12 }),
        Brick0: tx({ id: "Town.Ball.Brick0", atlas: 0, x: 744, y: 380, width: 36, height: 30 }),
        Brick1: tx({ id: "Town.Ball.Brick1", atlas: 0, x: 704, y: 407, width: 36, height: 20 }),
        ColumnSpiral0: tx({ id: "Town.Ball.ColumnSpiral0", atlas: 0, x: 818, y: 396, width: 12, height: 20 }),
        Dice: tx({ id: "Town.Ball.Dice", atlas: 0, x: 577, y: 468, width: 10, height: 10 }),
        FishmongerBombDefused: tx({ id: "Town.Ball.FishmongerBombDefused", atlas: 0, x: 194, y: 357, width: 52, height: 28 }),
        FishmongerBomb: tx({ id: "Town.Ball.FishmongerBomb", atlas: 0, x: 344, y: 438, width: 52, height: 28 }),
        ...
        StructureHighlight: tx({ id: "Town.Ball.StructureHighlight", atlas: 0, x: 834, y: 376, width: 40, height: 40 }),
        ...
        Symbols: {
          Circle: tx({ id: "Town.Ball.Symbols.Circle", atlas: 0, x: 559, y: 428, width: 28, height: 28 }),
          P: tx({ id: "Town.Ball.Symbols.P", atlas: 0, x: 161, y: 220, width: 26, height: 28 }),
          Square: tx({ id: "Town.Ball.Symbols.Square", atlas: 0, x: 741, y: 411, width: 34, height: 30 }),
          Star: tx({ id: "Town.Ball.Symbols.Star", atlas: 0, x: 625, y: 379, width: 40, height: 30 }),
        },
      },
      Colossus: {
        Eyebrow0: tx({ id: "Town.Colossus.Eyebrow0", atlas: 0, x: 755, y: 371, width: 26, height: 8 }),
        Eyelid0: tx({ id: "Town.Colossus.Eyelid0", atlas: 0, x: 644, y: 450, width: 20, height: 14 }),
        Mouth0: tx({ id: "Town.Colossus.Mouth0", atlas: 0, x: 781, y: 396, width: 36, height: 8 }),
        Noggin0: tx({ id: "Town.Colossus.Noggin0", atlas: 0, x: 194, y: 394, width: 84, height: 38 }),
        Nose0: tx({ id: "Town.Colossus.Nose0", atlas: 0, x: 644, y: 465, width: 18, height: 12 }),
        Pupil0: tx({ id: "Town.Colossus.Pupil0", atlas: 0, x: 695, y: 433, width: 8, height: 16 }),
        Sclera0: tx({ id: "Town.Colossus.Sclera0", atlas: 0, x: 247, y: 312, width: 18, height: 24 }),
      },
      Signage: {
    ...
    Ui: {
      ...
      InteractionIndicator: tx({ id: "Ui.InteractionIndicator", atlas: 0, x: 533, y: 444, width: 22, height: 22 }),
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 91, y: 440, width: 8, height: 8 }),
      PlacementReticle: tx({ id: "Ui.PlacementReticle", atlas: 0, x: 809, y: 428, width: 6, height: 6 }),
      Pocket: {
