...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Collectibles: {
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 838, y: 100, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 743, y: 60, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 819, y: 111, width: 17, height: 13 }),
    },
    Effects: {
      PoisonDripSmall: tx({ id: "Effects.PoisonDripSmall", atlas: 0, x: 856, y: 100, width: 1, height: 2 }),
      ...
      WaterDripSmall: tx({ id: "Effects.WaterDripSmall", atlas: 0, x: 856, y: 103, width: 1, height: 2 }),
      WaterDripXsmall: tx({ id: "Effects.WaterDripXsmall", atlas: 0, x: 856, y: 106, width: 1, height: 2 }),
    },
    Enemy: {
      CommonClown: tx({ id: "Enemy.CommonClown", atlas: 0, x: 743, y: 67, width: 44, height: 32 }),
      SpikeBall: tx({ id: "Enemy.SpikeBall", atlas: 0, x: 1009, y: 24, width: 14, height: 14 }),
    },
    Font: {
    ...
    Iguana: {
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 1016, y: 0, width: 8, height: 8 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 765, y: 31, width: 140, height: 12 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 883, y: 86, width: 18, height: 18 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 858, y: 86, width: 24, height: 24 }),
    },
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 827, y: 67, width: 30, height: 32 }),
    Metal: {
      PipeDarkBroken: tx({ id: "Metal.PipeDarkBroken", atlas: 0, x: 1016, y: 74, width: 4, height: 12 }),
    },
    OpenDoor: tx({ id: "OpenDoor", atlas: 0, x: 788, y: 94, width: 30, height: 32 }),
    OversizedAngel: tx({ id: "OversizedAngel", atlas: 0, x: 0, y: 31, width: 396, height: 51 }),
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 1009, y: 39, width: 14, height: 14 }),
    Pottery: {
      ...
      HangerTriangle: tx({ id: "Pottery.HangerTriangle", atlas: 0, x: 902, y: 96, width: 14, height: 14 }),
      HeadGreen: tx({ id: "Pottery.HeadGreen", atlas: 0, x: 1003, y: 56, width: 14, height: 8 }),
      HeadRed: tx({ id: "Pottery.HeadRed", atlas: 0, x: 996, y: 0, width: 14, height: 8 }),
      HeadYellow: tx({ id: "Pottery.HeadYellow", atlas: 0, x: 883, y: 105, width: 14, height: 8 }),
      PlantBushRed: tx({ id: "Pottery.PlantBushRed", atlas: 0, x: 819, y: 100, width: 18, height: 10 }),
      PlantReed: tx({ id: "Pottery.PlantReed", atlas: 0, x: 891, y: 67, width: 10, height: 16 }),
    },
    Stone: {
    ...
    Ui: {
      ...
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 1016, y: 87, width: 8, height: 8 }),
      PlacementReticle: tx({ id: "Ui.PlacementReticle", atlas: 0, x: 1011, y: 17, width: 6, height: 6 }),
    },
    Wood: {
      Sign: tx({ id: "Wood.Sign", atlas: 0, x: 858, y: 67, width: 32, height: 18 }),
    },
  };
}
