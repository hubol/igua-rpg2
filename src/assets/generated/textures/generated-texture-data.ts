...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Collectibles: {
      ...
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 284, y: 76, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 624, y: 158, width: 17, height: 13 }),
    },
    Effects: {
      PoisonDripSmall: tx({ id: "Effects.PoisonDripSmall", atlas: 0, x: 1013, y: 24, width: 1, height: 2 }),
      ...
      WaterDripSmall: tx({ id: "Effects.WaterDripSmall", atlas: 0, x: 214, y: 177, width: 1, height: 2 }),
      WaterDripXsmall: tx({ id: "Effects.WaterDripXsmall", atlas: 0, x: 1013, y: 27, width: 1, height: 2 }),
    },
    Enemy: {
      CommonClown: tx({ id: "Enemy.CommonClown", atlas: 0, x: 593, y: 177, width: 44, height: 32 }),
      SpikeBall: tx({ id: "Enemy.SpikeBall", atlas: 0, x: 160, y: 177, width: 14, height: 14 }),
    },
    Foliage: {
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 89, y: 169, width: 26, height: 31 }),
      Small: tx({ id: "Foliage.Small", atlas: 0, x: 1001, y: 24, width: 11, height: 17 }),
    },
    Font: {
    ...
    Iguana: {
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 498, y: 147, width: 48, height: 48 }),
    },
    Light: {
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 224, y: 159, width: 16, height: 8 }),
    },
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 25, y: 169, width: 30, height: 32 }),
    Metal: {
      PipeDarkBroken: tx({ id: "Metal.PipeDarkBroken", atlas: 0, x: 1020, y: 89, width: 4, height: 12 }),
    },
    OpenDoor: tx({ id: "OpenDoor", atlas: 0, x: 547, y: 177, width: 45, height: 48 }),
    OversizedAngel: tx({ id: "OversizedAngel", atlas: 0, x: 501, y: 31, width: 396, height: 51 }),
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 175, y: 177, width: 14, height: 14 }),
    Pottery: {
      Ball0: tx({ id: "Pottery.Ball0", atlas: 0, x: 138, y: 177, width: 21, height: 20 }),
      BodyGreen: tx({ id: "Pottery.BodyGreen", atlas: 0, x: 116, y: 194, width: 20, height: 4 }),
      ...
      HangerTriangle: tx({ id: "Pottery.HangerTriangle", atlas: 0, x: 190, y: 177, width: 14, height: 14 }),
      ...
      PlantReed: tx({ id: "Pottery.PlantReed", atlas: 0, x: 547, y: 147, width: 10, height: 16 }),
    },
    Shapes: {
      ...
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 56, y: 169, width: 32, height: 32 }),
    },
    Sky: {
    ...
    Stone: {
      ...
      IrregularWall: tx({ id: "Stone.IrregularWall", atlas: 0, x: 0, y: 169, width: 24, height: 34 }),
      RockLargeShaded: tx({ id: "Stone.RockLargeShaded", atlas: 0, x: 781, y: 125, width: 38, height: 26 }),
      RockSmallShaded1: tx({ id: "Stone.RockSmallShaded1", atlas: 0, x: 493, y: 67, width: 7, height: 6 }),
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 445, y: 67, width: 24, height: 15 }),
    },
    Terrain: {
      Earth: {
        Asterisk: tx({ id: "Terrain.Earth.Asterisk", atlas: 0, x: 116, y: 169, width: 21, height: 24 }),
    ...
    Ui: {
      ...
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 205, y: 177, width: 8, height: 8 }),
