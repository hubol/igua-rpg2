...
const atlases = [{ url: require("./atlas0.png"), texturesCount: 191 }];
...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Collectibles: {
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 627, y: 466, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 501, y: 303, width: 8, height: 8 }),
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 559, y: 493, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 312, y: 494, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 108, y: 517, width: 17, height: 13 }),
    },
    Door: {
    ...
    Effects: {
      Bubble4: tx({ id: "Effects.Bubble4", atlas: 0, x: 716, y: 411, width: 4, height: 4 }),
      Burst32: tx({ id: "Effects.Burst32", atlas: 0, x: 374, y: 464, width: 32, height: 22 }),
      ...
      Star12px: tx({ id: "Effects.Star12px", atlas: 0, x: 508, y: 454, width: 12, height: 10 }),
      ValuableSparkle: tx({ id: "Effects.ValuableSparkle", atlas: 0, x: 485, y: 446, width: 35, height: 7 }),
    ...
    Enemy: {
      ...
      SpikeBall: tx({ id: "Enemy.SpikeBall", atlas: 0, x: 849, y: 438, width: 24, height: 20 }),
      Suggestive: {
        ...
        Gear: tx({ id: "Enemy.Suggestive.Gear", atlas: 0, x: 407, y: 464, width: 32, height: 16 }),
    ...
    Esoteric: {
      Decoration: {
        ...
        SeedBag: tx({ id: "Esoteric.Decoration.SeedBag", atlas: 0, x: 407, y: 481, width: 32, height: 31 }),
      },
      Message: {
    ...
    Foliage: {
      Flower14: tx({ id: "Foliage.Flower14", atlas: 0, x: 1010, y: 186, width: 14, height: 8 }),
      Flower18: tx({ id: "Foliage.Flower18", atlas: 0, x: 779, y: 421, width: 18, height: 10 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 134, y: 437, width: 16, height: 16 }),
      Leaf36: tx({ id: "Foliage.Leaf36", atlas: 0, x: 468, y: 193, width: 36, height: 22 }),
      LeavesMedium0: tx({ id: "Foliage.LeavesMedium0", atlas: 0, x: 91, y: 437, width: 42, height: 60 }),
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 351, y: 487, width: 26, height: 31 }),
    ...
    Furniture: {
      Aquarium: {
        ...
        Coral: tx({ id: "Furniture.Aquarium.Coral", atlas: 0, x: 378, y: 487, width: 28, height: 26 }),
        ...
        WaterIntake: tx({ id: "Furniture.Aquarium.WaterIntake", atlas: 0, x: 351, y: 468, width: 22, height: 14 }),
      },
      ...
      WateringCan: tx({ id: "Furniture.WateringCan", atlas: 0, x: 521, y: 446, width: 34, height: 22 }),
    },
    ...
    Iguana: {
      Boiled: {
        ...
        Eye: tx({ id: "Iguana.Boiled.Eye", atlas: 0, x: 500, y: 497, width: 12, height: 12 }),
        Foot: tx({ id: "Iguana.Boiled.Foot", atlas: 0, x: 257, y: 193, width: 210, height: 18 }),
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 556, y: 446, width: 27, height: 27 }),
        ...
        Torso: tx({ id: "Iguana.Boiled.Torso", atlas: 0, x: 242, y: 472, width: 36, height: 36 }),
      },
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 513, y: 497, width: 12, height: 12 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 257, y: 212, width: 210, height: 18 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 508, y: 469, width: 27, height: 27 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 374, y: 427, width: 36, height: 36 }),
    },
    Light: {
      ...
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 1011, y: 159, width: 12, height: 10 }),
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 134, y: 454, width: 16, height: 8 }),
    },
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 320, y: 468, width: 30, height: 32 }),
    Metal: {
      PipeDarkBroken: tx({ id: "Metal.PipeDarkBroken", atlas: 0, x: 290, y: 358, width: 4, height: 12 }),
    },
    ...
    Pottery: {
      Ball0: tx({ id: "Pottery.Ball0", atlas: 0, x: 650, y: 466, width: 22, height: 20 }),
      ...
      BodyYellow: tx({ id: "Pottery.BodyYellow", atlas: 0, x: 697, y: 357, width: 20, height: 4 }),
      Figure0: tx({ id: "Pottery.Figure0", atlas: 0, x: 684, y: 432, width: 48, height: 37 }),
      HangerTriangle: tx({ id: "Pottery.HangerTriangle", atlas: 0, x: 1010, y: 195, width: 14, height: 14 }),
      HeadGreen: tx({ id: "Pottery.HeadGreen", atlas: 0, x: 1010, y: 57, width: 14, height: 8 }),
      HeadRed: tx({ id: "Pottery.HeadRed", atlas: 0, x: 1010, y: 210, width: 14, height: 8 }),
      HeadYellow: tx({ id: "Pottery.HeadYellow", atlas: 0, x: 1010, y: 66, width: 14, height: 8 }),
      PlantBushRed: tx({ id: "Pottery.PlantBushRed", atlas: 0, x: 1006, y: 267, width: 18, height: 10 }),
      PlantReed: tx({ id: "Pottery.PlantReed", atlas: 0, x: 673, y: 466, width: 10, height: 16 }),
    ...
    Shapes: {
      ...
      Confetti45deg: tx({ id: "Shapes.Confetti45deg", atlas: 0, x: 473, y: 485, width: 26, height: 26 }),
      Confetti18x8: tx({ id: "Shapes.Confetti18x8", atlas: 0, x: 607, y: 471, width: 18, height: 8 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 134, y: 463, width: 16, height: 16 }),
      ...
      RightTriangle24px: tx({ id: "Shapes.RightTriangle24px", atlas: 0, x: 440, y: 489, width: 24, height: 22 }),
      SquareIrregular10: tx({ id: "Shapes.SquareIrregular10", atlas: 0, x: 539, y: 497, width: 10, height: 10 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 242, y: 509, width: 32, height: 32 }),
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 171, y: 513, width: 10, height: 10 }),
      X22: tx({ id: "Shapes.X22", atlas: 0, x: 584, y: 471, width: 22, height: 16 }),
      Zigzag14: tx({ id: "Shapes.Zigzag14", atlas: 0, x: 134, y: 480, width: 14, height: 8 }),
    },
    Sky: {
    ...
    Stone: {
      ...
      BrickRegular: tx({ id: "Stone.BrickRegular", atlas: 0, x: 228, y: 331, width: 22, height: 13 }),
      IrregularWall: tx({ id: "Stone.IrregularWall", atlas: 0, x: 448, y: 454, width: 24, height: 34 }),
      RockLargeShaded: tx({ id: "Stone.RockLargeShaded", atlas: 0, x: 281, y: 467, width: 38, height: 26 }),
      RockSmallShaded1: tx({ id: "Stone.RockSmallShaded1", atlas: 0, x: 849, y: 459, width: 7, height: 6 }),
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 993, y: 170, width: 24, height: 15 }),
    ...
    Terrain: {
      Earth: {
        Asterisk: tx({ id: "Terrain.Earth.Asterisk", atlas: 0, x: 584, y: 446, width: 21, height: 24 }),
        ...
        CrackSmall0: tx({ id: "Terrain.Earth.CrackSmall0", atlas: 0, x: 536, y: 469, width: 8, height: 4 }),
        ExposedDirt: tx({ id: "Terrain.Earth.ExposedDirt", atlas: 0, x: 519, y: 347, width: 80, height: 14 }),
        Loop: tx({ id: "Terrain.Earth.Loop", atlas: 0, x: 607, y: 480, width: 17, height: 18 }),
        ...
        V: tx({ id: "Terrain.Earth.V", atlas: 0, x: 559, y: 474, width: 20, height: 18 }),
        ValuableBlue0: tx({ id: "Terrain.Earth.ValuableBlue0", atlas: 0, x: 606, y: 446, width: 20, height: 24 }),
        ValuableRed0: tx({ id: "Terrain.Earth.ValuableRed0", atlas: 0, x: 150, y: 513, width: 20, height: 14 }),
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 526, y: 497, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 126, y: 517, width: 14, height: 12 }),
        Brick0: tx({ id: "Town.Ball.Brick0", atlas: 0, x: 411, y: 433, width: 36, height: 30 }),
        Brick1: tx({ id: "Town.Ball.Brick1", atlas: 0, x: 448, y: 433, width: 36, height: 20 }),
        ColumnSpiral0: tx({ id: "Town.Ball.ColumnSpiral0", atlas: 0, x: 1011, y: 138, width: 12, height: 20 }),
        Dice: tx({ id: "Town.Ball.Dice", atlas: 0, x: 182, y: 513, width: 10, height: 10 }),
        ...
        Symbols: {
          Circle: tx({ id: "Town.Ball.Symbols.Circle", atlas: 0, x: 312, y: 501, width: 28, height: 28 }),
          P: tx({ id: "Town.Ball.Symbols.P", atlas: 0, x: 275, y: 527, width: 26, height: 28 }),
          Square: tx({ id: "Town.Ball.Symbols.Square", atlas: 0, x: 473, y: 454, width: 34, height: 30 }),
          Star: tx({ id: "Town.Ball.Symbols.Star", atlas: 0, x: 290, y: 436, width: 40, height: 30 }),
        },
      },
      Colossus: {
        Eyebrow0: tx({ id: "Town.Colossus.Eyebrow0", atlas: 0, x: 228, y: 322, width: 26, height: 8 }),
        Eyelid0: tx({ id: "Town.Colossus.Eyelid0", atlas: 0, x: 87, y: 517, width: 20, height: 14 }),
        Mouth0: tx({ id: "Town.Colossus.Mouth0", atlas: 0, x: 468, y: 216, width: 36, height: 8 }),
        Noggin0: tx({ id: "Town.Colossus.Noggin0", atlas: 0, x: 434, y: 347, width: 84, height: 38 }),
        Nose0: tx({ id: "Town.Colossus.Nose0", atlas: 0, x: 580, y: 488, width: 18, height: 12 }),
    ...
    Ui: {
      ...
      InteractionIndicator: tx({ id: "Ui.InteractionIndicator", atlas: 0, x: 536, y: 474, width: 22, height: 22 }),
