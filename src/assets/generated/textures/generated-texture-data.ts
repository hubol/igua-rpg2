...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Effects: {
      PoisonDripSmall: tx({ id: "Effects.PoisonDripSmall", atlas: 0, x: 904, y: 67, width: 1, height: 2 }),
      ...
      WaterDripXsmall: tx({ id: "Effects.WaterDripXsmall", atlas: 0, x: 904, y: 70, width: 1, height: 2 }),
    },
    Enemy: {
