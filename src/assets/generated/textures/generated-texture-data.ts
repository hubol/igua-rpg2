...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Iguana: {
      ...
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 815, y: 67, width: 18, height: 18 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 992, y: 0, width: 24, height: 24 }),
    },
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 663, y: 69, width: 30, height: 32 }),
    OpenDoor: tx({ id: "OpenDoor", atlas: 0, x: 614, y: 82, width: 30, height: 32 }),
    ...
    Terrain: {
      Pipe: {
        Gray: tx({ id: "Terrain.Pipe.Gray", atlas: 0, x: 1019, y: 0, width: 1, height: 9 }),
      },
    },
    Ui: {
      ...
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 1009, y: 63, width: 8, height: 8 }),
      PlacementReticle: tx({ id: "Ui.PlacementReticle", atlas: 0, x: 742, y: 60, width: 6, height: 6 }),
    },
  };
}
