...
const atlases = [{ url: require("./atlas0.png"), texturesCount: 235 }];
...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      BallFruitTypeA: tx({ id: "Collectibles.BallFruitTypeA", atlas: 0, x: 500, y: 748, width: 22, height: 20 }),
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 724, y: 670, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 209, y: 702, width: 8, height: 8 }),
      ComputerChip: tx({ id: "Collectibles.ComputerChip", atlas: 0, x: 680, y: 681, width: 22, height: 20 }),
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 569, y: 734, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 768, y: 567, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 768, y: 692, width: 17, height: 13 }),
    },
    Door: {
    ...
    Effects: {
      ...
      Bubble4: tx({ id: "Effects.Bubble4", atlas: 0, x: 111, y: 832, width: 4, height: 4 }),
      Burst32: tx({ id: "Effects.Burst32", atlas: 0, x: 492, y: 671, width: 32, height: 22 }),
      ...
      Star12px: tx({ id: "Effects.Star12px", atlas: 0, x: 983, y: 666, width: 12, height: 10 }),
    ...
    Enemy: {
      ...
      SpikeBall: tx({ id: "Enemy.SpikeBall", atlas: 0, x: 1000, y: 735, width: 24, height: 20 }),
      Suggestive: {
        ...
        Face: tx({ id: "Enemy.Suggestive.Face", atlas: 0, x: 944, y: 668, width: 38, height: 24 }),
        Gear: tx({ id: "Enemy.Suggestive.Gear", atlas: 0, x: 525, y: 671, width: 32, height: 16 }),
        ...
        ScleraWide: tx({ id: "Enemy.Suggestive.ScleraWide", atlas: 0, x: 776, y: 524, width: 14, height: 6 }),
        Sclera: tx({ id: "Enemy.Suggestive.Sclera", atlas: 0, x: 542, y: 749, width: 8, height: 16 }),
        Torso: tx({ id: "Enemy.Suggestive.Torso", atlas: 0, x: 938, y: 266, width: 86, height: 23 }),
      },
    },
    Esoteric: {
      Decoration: {
        Bandage: tx({ id: "Esoteric.Decoration.Bandage", atlas: 0, x: 684, y: 649, width: 12, height: 26 }),
        PicaxeGiant: tx({ id: "Esoteric.Decoration.PicaxeGiant", atlas: 0, x: 0, y: 655, width: 72, height: 69 }),
        SeedBag: tx({ id: "Esoteric.Decoration.SeedBag", atlas: 0, x: 593, y: 649, width: 32, height: 31 }),
      },
      Message: {
    ...
    Fiber: {
      Cobweb0: tx({ id: "Fiber.Cobweb0", atlas: 0, x: 492, y: 694, width: 30, height: 28 }),
      Cobweb1: tx({ id: "Fiber.Cobweb1", atlas: 0, x: 965, y: 178, width: 20, height: 28 }),
      RopeFrame: tx({ id: "Fiber.RopeFrame", atlas: 0, x: 981, y: 706, width: 37, height: 28 }),
    ...
    Foliage: {
      ...
      Flower14: tx({ id: "Foliage.Flower14", atlas: 0, x: 703, y: 681, width: 14, height: 8 }),
      Flower18: tx({ id: "Foliage.Flower18", atlas: 0, x: 1006, y: 317, width: 18, height: 10 }),
      Flower22: tx({ id: "Foliage.Flower22", atlas: 0, x: 653, y: 693, width: 22, height: 16 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 523, y: 762, width: 16, height: 16 }),
      Leaf36: tx({ id: "Foliage.Leaf36", atlas: 0, x: 891, y: 699, width: 36, height: 22 }),
      LeavesMedium0: tx({ id: "Foliage.LeavesMedium0", atlas: 0, x: 418, y: 463, width: 42, height: 60 }),
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 84, y: 832, width: 26, height: 31 }),
      Moss0: tx({ id: "Foliage.Moss0", atlas: 0, x: 620, y: 720, width: 16, height: 18 }),
      ...
      Small: tx({ id: "Foliage.Small", atlas: 0, x: 146, y: 666, width: 11, height: 17 }),
      Stem16: tx({ id: "Foliage.Stem16", atlas: 0, x: 928, y: 699, width: 14, height: 16 }),
      ...
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 928, y: 716, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      Aquarium: {
        ...
        Coral: tx({ id: "Furniture.Aquarium.Coral", atlas: 0, x: 626, y: 649, width: 28, height: 26 }),
        ...
        WaterIntake: tx({ id: "Furniture.Aquarium.WaterIntake", atlas: 0, x: 620, y: 705, width: 22, height: 14 }),
      },
      ...
      Doll0: tx({ id: "Furniture.Doll0", atlas: 0, x: 443, y: 717, width: 28, height: 30 }),
      Lamp0: tx({ id: "Furniture.Lamp0", atlas: 0, x: 153, y: 805, width: 22, height: 28 }),
      Library: {
        Books0: tx({ id: "Furniture.Library.Books0", atlas: 0, x: 996, y: 619, width: 12, height: 14 }),
        Books1: tx({ id: "Furniture.Library.Books1", atlas: 0, x: 747, y: 694, width: 16, height: 12 }),
        Books2: tx({ id: "Furniture.Library.Books2", atlas: 0, x: 726, y: 706, width: 14, height: 16 }),
      },
      Pottery18: tx({ id: "Furniture.Pottery18", atlas: 0, x: 587, y: 723, width: 18, height: 18 }),
      Table0: tx({ id: "Furniture.Table0", atlas: 0, x: 146, y: 702, width: 62, height: 22 }),
      WateringCan: tx({ id: "Furniture.WateringCan", atlas: 0, x: 965, y: 735, width: 34, height: 22 }),
    },
    Iguana: {
      Boiled: {
        ...
        Eye: tx({ id: "Iguana.Boiled.Eye", atlas: 0, x: 35, y: 848, width: 12, height: 12 }),
        Foot: tx({ id: "Iguana.Boiled.Foot", atlas: 0, x: 681, y: 311, width: 210, height: 18 }),
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 523, y: 721, width: 27, height: 27 }),
        ...
        Torso: tx({ id: "Iguana.Boiled.Torso", atlas: 0, x: 891, y: 722, width: 36, height: 36 }),
      },
      ...
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 472, y: 723, width: 27, height: 27 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 928, y: 732, width: 36, height: 36 }),
    },
    Light: {
      ...
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 903, y: 658, width: 16, height: 8 }),
    },
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 764, y: 706, width: 14, height: 14 }),
    Shapes: {
      Arc24: tx({ id: "Shapes.Arc24", atlas: 0, x: 1000, y: 756, width: 24, height: 4 }),
      ...
      Confetti45deg: tx({ id: "Shapes.Confetti45deg", atlas: 0, x: 697, y: 654, width: 26, height: 26 }),
      Confetti18x8: tx({ id: "Shapes.Confetti18x8", atlas: 0, x: 1006, y: 328, width: 18, height: 8 }),
      Confetti32: tx({ id: "Shapes.Confetti32", atlas: 0, x: 558, y: 680, width: 32, height: 32 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 786, y: 692, width: 16, height: 16 }),
      ...
      RightTriangle24px: tx({ id: "Shapes.RightTriangle24px", atlas: 0, x: 1000, y: 761, width: 24, height: 22 }),
      SquareIrregular10: tx({ id: "Shapes.SquareIrregular10", atlas: 0, x: 73, y: 655, width: 10, height: 10 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 525, y: 688, width: 32, height: 32 }),
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 961, y: 242, width: 10, height: 10 }),
      X22: tx({ id: "Shapes.X22", atlas: 0, x: 703, y: 691, width: 22, height: 16 }),
      Zigzag14: tx({ id: "Shapes.Zigzag14", atlas: 0, x: 946, y: 242, width: 14, height: 8 }),
    },
    Sky: {
    ...
    Stone: {
      ...
      RockLargeShaded: tx({ id: "Stone.RockLargeShaded", atlas: 0, x: 983, y: 679, width: 38, height: 26 }),
      RockSmallShaded1: tx({ id: "Stone.RockSmallShaded1", atlas: 0, x: 65, y: 763, width: 7, height: 6 }),
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 724, y: 654, width: 24, height: 15 }),
    ...
    Terrain: {
      Earth: {
        ...
        Loop: tx({ id: "Terrain.Earth.Loop", atlas: 0, x: 551, y: 734, width: 17, height: 18 }),
        Mass0: tx({ id: "Terrain.Earth.Mass0", atlas: 0, x: 559, y: 567, width: 137, height: 81 }),
        QuestionMarkStencil0: tx({ id: "Terrain.Earth.QuestionMarkStencil0", atlas: 0, x: 676, y: 702, width: 22, height: 14 }),
        QuestionMark: tx({ id: "Terrain.Earth.QuestionMark", atlas: 0, x: 749, y: 654, width: 18, height: 24 }),
        ...
        ValuableRed0: tx({ id: "Terrain.Earth.ValuableRed0", atlas: 0, x: 747, y: 679, width: 20, height: 14 }),
      ...
      Grass: {
        ...
        Tall3px: tx({ id: "Terrain.Grass.Tall3px", atlas: 0, x: 965, y: 758, width: 34, height: 18 }),
      },
      Pipe: {
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 606, y: 723, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 741, y: 707, width: 14, height: 12 }),
        Brick0: tx({ id: "Town.Ball.Brick0", atlas: 0, x: 116, y: 805, width: 36, height: 30 }),
        ...
        Dice: tx({ id: "Town.Ball.Dice", atlas: 0, x: 972, y: 242, width: 10, height: 10 }),
        ...
        Symbols: {
          Circle: tx({ id: "Town.Ball.Symbols.Circle", atlas: 0, x: 655, y: 649, width: 28, height: 28 }),
          P: tx({ id: "Town.Ball.Symbols.P", atlas: 0, x: 626, y: 676, width: 26, height: 28 }),
          Square: tx({ id: "Town.Ball.Symbols.Square", atlas: 0, x: 49, y: 832, width: 34, height: 30 }),
          Star: tx({ id: "Town.Ball.Symbols.Star", atlas: 0, x: 903, y: 668, width: 40, height: 30 }),
        },
      ...
      Colossus: {
        ...
        Eyebrow1: tx({ id: "Town.Colossus.Eyebrow1", atlas: 0, x: 653, y: 678, width: 26, height: 14 }),
        Eyelid0: tx({ id: "Town.Colossus.Eyelid0", atlas: 0, x: 726, y: 691, width: 20, height: 14 }),
        ...
        Nose0: tx({ id: "Town.Colossus.Nose0", atlas: 0, x: 523, y: 749, width: 18, height: 12 }),
        Pupil0: tx({ id: "Town.Colossus.Pupil0", atlas: 0, x: 85, y: 616, width: 8, height: 16 }),
        Pupil1: tx({ id: "Town.Colossus.Pupil1", atlas: 0, x: 0, y: 848, width: 34, height: 14 }),
        Pupil2: tx({ id: "Town.Colossus.Pupil2", atlas: 0, x: 35, y: 861, width: 12, height: 12 }),
        Sclera0: tx({ id: "Town.Colossus.Sclera0", atlas: 0, x: 500, y: 723, width: 18, height: 24 }),
        Sclera1: tx({ id: "Town.Colossus.Sclera1", atlas: 0, x: 497, y: 603, width: 60, height: 36 }),
        Sclera2: tx({ id: "Town.Colossus.Sclera2", atlas: 0, x: 854, y: 693, width: 36, height: 40 }),
        Tooth0: tx({ id: "Town.Colossus.Tooth0", atlas: 0, x: 235, y: 641, width: 4, height: 18 }),
      },
      Monument: {
        Lazarus: tx({ id: "Town.Monument.Lazarus", atlas: 0, x: 924, y: 625, width: 36, height: 42 }),
      ...
      Underneath: {
        HeliumCreator: tx({ id: "Town.Underneath.HeliumCreator", atlas: 0, x: 944, y: 693, width: 36, height: 38 }),
        ...
        RiserFaceHappy: tx({ id: "Town.Underneath.RiserFaceHappy", atlas: 0, x: 591, y: 681, width: 28, height: 20 }),
        RiserFaceSurprise: tx({ id: "Town.Underneath.RiserFaceSurprise", atlas: 0, x: 591, y: 702, width: 28, height: 20 }),
        RiserFace: tx({ id: "Town.Underneath.RiserFace", atlas: 0, x: 558, y: 713, width: 28, height: 20 }),
      },
    },
    Ui: {
      ...
      InteractionIndicator: tx({ id: "Ui.InteractionIndicator", atlas: 0, x: 643, y: 710, width: 22, height: 22 }),
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 408, y: 607, width: 8, height: 8 }),
    ...
    Wood: {
      ...
      Crate0: tx({ id: "Wood.Crate0", atlas: 0, x: 558, y: 649, width: 34, height: 30 }),
