...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Collectibles: {
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 783, y: 502, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 997, y: 116, width: 8, height: 8 }),
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 1006, y: 224, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 569, y: 391, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 644, y: 478, width: 17, height: 13 }),
    },
    Door: {
      NormalLocked: tx({ id: "Door.NormalLocked", atlas: 0, x: 468, y: 193, width: 34, height: 46 }),
      NormalOpen: tx({ id: "Door.NormalOpen", atlas: 0, x: 863, y: 395, width: 34, height: 46 }),
    },
    Effects: {
    ...
    Enemy: {
      CommonClown: tx({ id: "Enemy.CommonClown", atlas: 0, x: 898, y: 395, width: 44, height: 32 }),
      SpikeBall: tx({ id: "Enemy.SpikeBall", atlas: 0, x: 671, y: 524, width: 24, height: 20 }),
      Suggestive: {
        Body: tx({ id: "Enemy.Suggestive.Body", atlas: 0, x: 0, y: 128, width: 504, height: 64 }),
        Face: tx({ id: "Enemy.Suggestive.Face", atlas: 0, x: 980, y: 438, width: 38, height: 24 }),
        ...
        Pupil: tx({ id: "Enemy.Suggestive.Pupil", atlas: 0, x: 863, y: 442, width: 2, height: 8 }),
        Sclera: tx({ id: "Enemy.Suggestive.Sclera", atlas: 0, x: 806, y: 502, width: 8, height: 16 }),
        Torso: tx({ id: "Enemy.Suggestive.Torso", atlas: 0, x: 931, y: 0, width: 86, height: 23 }),
      },
    },
    Esoteric: {
      Decoration: {
        Bandage: tx({ id: "Esoteric.Decoration.Bandage", atlas: 0, x: 816, y: 481, width: 12, height: 26 }),
      ...
      Message: {
        ...
        Miner: tx({ id: "Esoteric.Message.Miner", atlas: 0, x: 754, y: 392, width: 57, height: 15 }),
      },
    },
    Fiber: {
      RopeFrame: tx({ id: "Fiber.RopeFrame", atlas: 0, x: 791, y: 452, width: 37, height: 28 }),
    },
    Foliage: {
      Flower14: tx({ id: "Foliage.Flower14", atlas: 0, x: 1010, y: 41, width: 14, height: 8 }),
      Flower18: tx({ id: "Foliage.Flower18", atlas: 0, x: 1006, y: 164, width: 18, height: 10 }),
      LeavesMedium0: tx({ id: "Foliage.LeavesMedium0", atlas: 0, x: 650, y: 367, width: 42, height: 60 }),
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 734, y: 495, width: 26, height: 31 }),
      RootMedium0: tx({ id: "Foliage.RootMedium0", atlas: 0, x: 742, y: 438, width: 48, height: 19 }),
      Small: tx({ id: "Foliage.Small", atlas: 0, x: 779, y: 458, width: 11, height: 17 }),
      ...
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 718, y: 376, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      ...
      Pottery18: tx({ id: "Furniture.Pottery18", atlas: 0, x: 1006, y: 175, width: 18, height: 18 }),
      Table0: tx({ id: "Furniture.Table0", atlas: 0, x: 668, y: 323, width: 62, height: 22 }),
      WateringCan: tx({ id: "Furniture.WateringCan", atlas: 0, x: 664, y: 473, width: 34, height: 22 }),
    },
    ...
    Iguana: {
      Boiled: {
        ...
        Eye: tx({ id: "Iguana.Boiled.Eye", atlas: 0, x: 725, y: 346, width: 12, height: 12 }),
        Foot: tx({ id: "Iguana.Boiled.Foot", atlas: 0, x: 257, y: 193, width: 210, height: 18 }),
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 671, y: 496, width: 27, height: 27 }),
        ...
        Nails: tx({ id: "Iguana.Boiled.Nails", atlas: 0, x: 890, y: 116, width: 45, height: 9 }),
        ...
        Torso: tx({ id: "Iguana.Boiled.Torso", atlas: 0, x: 988, y: 395, width: 36, height: 36 }),
      },
      ...
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 699, y: 504, width: 27, height: 27 }),
      ...
      Nails: tx({ id: "Iguana.Nails", atlas: 0, x: 936, y: 116, width: 45, height: 9 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 742, y: 458, width: 36, height: 36 }),
    },
    Light: {
      ...
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 1011, y: 151, width: 12, height: 10 }),
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 1006, y: 238, width: 16, height: 8 }),
    },
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 866, y: 442, width: 30, height: 32 }),
    Metal: {
      PipeDarkBroken: tx({ id: "Metal.PipeDarkBroken", atlas: 0, x: 835, y: 286, width: 4, height: 12 }),
    },
    OpenDoor: tx({ id: "OpenDoor", atlas: 0, x: 569, y: 440, width: 45, height: 48 }),
    OversizedAngel: tx({ id: "OversizedAngel", atlas: 0, x: 505, y: 138, width: 396, height: 51 }),
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 1010, y: 50, width: 14, height: 14 }),
    Pottery: {
      Ball0: tx({ id: "Pottery.Ball0", atlas: 0, x: 897, y: 469, width: 22, height: 20 }),
      BodyGreen: tx({ id: "Pottery.BodyGreen", atlas: 0, x: 791, y: 438, width: 20, height: 4 }),
      BodyRed: tx({ id: "Pottery.BodyRed", atlas: 0, x: 1010, y: 65, width: 14, height: 4 }),
      BodyYellow: tx({ id: "Pottery.BodyYellow", atlas: 0, x: 791, y: 443, width: 20, height: 4 }),
      Figure0: tx({ id: "Pottery.Figure0", atlas: 0, x: 615, y: 440, width: 48, height: 37 }),
      HangerTriangle: tx({ id: "Pottery.HangerTriangle", atlas: 0, x: 579, y: 329, width: 14, height: 14 }),
      HeadGreen: tx({ id: "Pottery.HeadGreen", atlas: 0, x: 1010, y: 70, width: 14, height: 8 }),
      HeadRed: tx({ id: "Pottery.HeadRed", atlas: 0, x: 982, y: 116, width: 14, height: 8 }),
      HeadYellow: tx({ id: "Pottery.HeadYellow", atlas: 0, x: 846, y: 483, width: 14, height: 8 }),
      PlantBushRed: tx({ id: "Pottery.PlantBushRed", atlas: 0, x: 1006, y: 194, width: 18, height: 10 }),
      PlantReed: tx({ id: "Pottery.PlantReed", atlas: 0, x: 829, y: 364, width: 10, height: 16 }),
      Plant0: tx({ id: "Pottery.Plant0", atlas: 0, x: 693, y: 423, width: 48, height: 49 }),
    },
    Shapes: {
      Arc24: tx({ id: "Shapes.Arc24", atlas: 0, x: 988, y: 432, width: 24, height: 4 }),
      ...
      Circle64: tx({ id: "Shapes.Circle64", atlas: 0, x: 504, y: 391, width: 64, height: 64 }),
      Confetti32: tx({ id: "Shapes.Confetti32", atlas: 0, x: 991, y: 323, width: 32, height: 32 }),
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 829, y: 483, width: 16, height: 16 }),
      ...
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 991, y: 356, width: 32, height: 32 }),
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 829, y: 381, width: 10, height: 10 }),
      Zigzag14: tx({ id: "Shapes.Zigzag14", atlas: 0, x: 861, y: 489, width: 14, height: 8 }),
    },
    Sky: {
    ...
    Stone: {
      ...
      BrickRegular: tx({ id: "Stone.BrickRegular", atlas: 0, x: 866, y: 475, width: 22, height: 13 }),
      IrregularWall: tx({ id: "Stone.IrregularWall", atlas: 0, x: 664, y: 437, width: 24, height: 34 }),
      RockLargeShaded: tx({ id: "Stone.RockLargeShaded", atlas: 0, x: 980, y: 463, width: 38, height: 26 }),
      RockSmallShaded1: tx({ id: "Stone.RockSmallShaded1", atlas: 0, x: 713, y: 244, width: 7, height: 6 }),
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 693, y: 376, width: 24, height: 15 }),
    },
    Terrain: {
      Earth: {
        Asterisk: tx({ id: "Terrain.Earth.Asterisk", atlas: 0, x: 761, y: 502, width: 21, height: 24 }),
        CrackSmall0: tx({ id: "Terrain.Earth.CrackSmall0", atlas: 0, x: 779, y: 476, width: 8, height: 4 }),
        ExposedDirt: tx({ id: "Terrain.Earth.ExposedDirt", atlas: 0, x: 518, y: 289, width: 80, height: 14 }),
        Loop: tx({ id: "Terrain.Earth.Loop", atlas: 0, x: 1006, y: 205, width: 17, height: 18 }),
      ...
      Grass: {
        Jagged2px: tx({ id: "Terrain.Grass.Jagged2px", atlas: 0, x: 650, y: 428, width: 42, height: 8 }),
        ...
        Shape1: tx({ id: "Terrain.Grass.Shape1", atlas: 0, x: 693, y: 367, width: 40, height: 8 }),
      },
      Pipe: {
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 829, y: 500, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 846, y: 492, width: 14, height: 12 }),
        Brick0: tx({ id: "Town.Ball.Brick0", atlas: 0, x: 829, y: 452, width: 36, height: 30 }),
        Brick1: tx({ id: "Town.Ball.Brick1", atlas: 0, x: 779, y: 481, width: 36, height: 20 }),
        Frame: tx({ id: "Town.Ball.Frame", atlas: 0, x: 812, y: 395, width: 50, height: 56 }),
        StructureHighlight: tx({ id: "Town.Ball.StructureHighlight", atlas: 0, x: 898, y: 428, width: 40, height: 40 }),
        Structure: tx({ id: "Town.Ball.Structure", atlas: 0, x: 840, y: 280, width: 150, height: 114 }),
        Symbols: {
          Circle: tx({ id: "Town.Ball.Symbols.Circle", atlas: 0, x: 615, y: 478, width: 28, height: 28 }),
          P: tx({ id: "Town.Ball.Symbols.P", atlas: 0, x: 644, y: 496, width: 26, height: 28 }),
          Square: tx({ id: "Town.Ball.Symbols.Square", atlas: 0, x: 699, y: 473, width: 34, height: 30 }),
          Star: tx({ id: "Town.Ball.Symbols.Star", atlas: 0, x: 939, y: 438, width: 40, height: 30 }),
        },
      },
    },
    Ui: {
      Checkbox: tx({ id: "Ui.Checkbox", atlas: 0, x: 693, y: 392, width: 60, height: 30 }),
      ...
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 742, y: 423, width: 8, height: 8 }),
    ...
    Wood: {
      ...
      Sign: tx({ id: "Wood.Sign", atlas: 0, x: 754, y: 408, width: 50, height: 29 }),
    },
  };
}
