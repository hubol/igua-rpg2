...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Iguana: {
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 1001, y: 22, width: 8, height: 8 }),
    ...
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 1009, y: 7, width: 14, height: 14 }),
    Ui: {
      ...
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 992, y: 22, width: 8, height: 8 }),
      PlacementReticle: tx({ id: "Ui.PlacementReticle", atlas: 0, x: 383, y: 83, width: 6, height: 6 }),
    },
  };
}
