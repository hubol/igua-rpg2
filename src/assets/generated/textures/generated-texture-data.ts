...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      BallFruitTypeA: tx({ id: "Collectibles.BallFruitTypeA", atlas: 0, x: 962, y: 618, width: 22, height: 20 }),
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 985, y: 628, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 859, y: 1016, width: 8, height: 8 }),
      ComputerChip: tx({ id: "Collectibles.ComputerChip", atlas: 0, x: 955, y: 639, width: 22, height: 20 }),
      Flop: {
        Body: tx({ id: "Collectibles.Flop.Body", atlas: 0, x: 883, y: 669, width: 28, height: 26 }),
    ...
    Effects: {
      ...
      Burst32: tx({ id: "Effects.Burst32", atlas: 0, x: 878, y: 829, width: 32, height: 22 }),
    ...
    Enemy: {
      ...
      SpikeBall: tx({ id: "Enemy.SpikeBall", atlas: 0, x: 901, y: 807, width: 24, height: 20 }),
      Spirit: {
      ...
      Suggestive: {
        ...
        Sclera: tx({ id: "Enemy.Suggestive.Sclera", atlas: 0, x: 829, y: 933, width: 8, height: 16 }),
    ...
    Esoteric: {
      Decoration: {
        ...
        SeedBag: tx({ id: "Esoteric.Decoration.SeedBag", atlas: 0, x: 845, y: 983, width: 32, height: 31 }),
      },
      Message: {
    ...
    Fiber: {
      Cobweb0: tx({ id: "Fiber.Cobweb0", atlas: 0, x: 880, y: 952, width: 30, height: 28 }),
    ...
    Foliage: {
      ...
      Flower14: tx({ id: "Foliage.Flower14", atlas: 0, x: 844, y: 1016, width: 14, height: 8 }),
      Flower18: tx({ id: "Foliage.Flower18", atlas: 0, x: 389, y: 872, width: 18, height: 10 }),
      Flower22: tx({ id: "Foliage.Flower22", atlas: 0, x: 768, y: 857, width: 22, height: 16 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 1008, y: 626, width: 16, height: 16 }),
      ...
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 875, y: 704, width: 26, height: 31 }),
      Moss0: tx({ id: "Foliage.Moss0", atlas: 0, x: 965, y: 230, width: 16, height: 18 }),
      ...
      Stem16: tx({ id: "Foliage.Stem16", atlas: 0, x: 956, y: 679, width: 14, height: 16 }),
      ...
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 582, y: 634, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      Aquarium: {
        ...
        Coral: tx({ id: "Furniture.Aquarium.Coral", atlas: 0, x: 898, y: 626, width: 28, height: 26 }),
        ...
        WaterIntake: tx({ id: "Furniture.Aquarium.WaterIntake", atlas: 0, x: 912, y: 681, width: 22, height: 14 }),
      },
      Artwork: {
      ...
      Doll0: tx({ id: "Furniture.Doll0", atlas: 0, x: 882, y: 918, width: 28, height: 30 }),
      Lamp0: tx({ id: "Furniture.Lamp0", atlas: 0, x: 1001, y: 574, width: 22, height: 28 }),
      Library: {
        Books0: tx({ id: "Furniture.Library.Books0", atlas: 0, x: 898, y: 653, width: 12, height: 14 }),
        Books1: tx({ id: "Furniture.Library.Books1", atlas: 0, x: 1008, y: 643, width: 16, height: 12 }),
        Books2: tx({ id: "Furniture.Library.Books2", atlas: 0, x: 971, y: 679, width: 14, height: 16 }),
      },
      PotionGreen: tx({ id: "Furniture.PotionGreen", atlas: 0, x: 965, y: 207, width: 16, height: 22 }),
      PotionRed: tx({ id: "Furniture.PotionRed", atlas: 0, x: 1008, y: 603, width: 16, height: 22 }),
      Pottery18: tx({ id: "Furniture.Pottery18", atlas: 0, x: 953, y: 660, width: 18, height: 18 }),
      ...
      WateringCan: tx({ id: "Furniture.WateringCan", atlas: 0, x: 874, y: 866, width: 34, height: 22 }),
    },
    Iguana: {
      Boiled: {
        ...
        Eye: tx({ id: "Iguana.Boiled.Eye", atlas: 0, x: 405, y: 828, width: 12, height: 12 }),
        Foot: tx({ id: "Iguana.Boiled.Foot", atlas: 0, x: 673, y: 370, width: 210, height: 18 }),
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 912, y: 653, width: 27, height: 27 }),
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 848, y: 738, width: 12, height: 12 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 0, y: 745, width: 210, height: 18 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 927, y: 624, width: 27, height: 27 }),
    ...
    Light: {
      ...
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 451, y: 693, width: 12, height: 10 }),
    ...
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 1007, y: 656, width: 14, height: 14 }),
    Shapes: {
      Arc24: tx({ id: "Shapes.Arc24", atlas: 0, x: 931, y: 76, width: 24, height: 4 }),
      ...
      Confetti45deg: tx({ id: "Shapes.Confetti45deg", atlas: 0, x: 935, y: 595, width: 26, height: 26 }),
      Confetti18x8: tx({ id: "Shapes.Confetti18x8", atlas: 0, x: 257, y: 922, width: 18, height: 8 }),
      Confetti32: tx({ id: "Shapes.Confetti32", atlas: 0, x: 878, y: 983, width: 32, height: 32 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 990, y: 649, width: 16, height: 16 }),
      ...
      RightTriangle24px: tx({ id: "Shapes.RightTriangle24px", atlas: 0, x: 962, y: 595, width: 24, height: 22 }),
      SquareIrregular10: tx({ id: "Shapes.SquareIrregular10", atlas: 0, x: 986, y: 393, width: 10, height: 10 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 866, y: 738, width: 32, height: 32 }),
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 978, y: 649, width: 10, height: 10 }),
      X22: tx({ id: "Shapes.X22", atlas: 0, x: 927, y: 717, width: 22, height: 16 }),
    ...
    Stone: {
      ...
      BrickSingle0: tx({ id: "Stone.BrickSingle0", atlas: 0, x: 965, y: 249, width: 16, height: 10 }),
      ...
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 819, y: 1007, width: 24, height: 15 }),
      ...
      ShinyRock0: tx({ id: "Stone.ShinyRock0", atlas: 0, x: 874, y: 889, width: 34, height: 28 }),
      ShinyRock1: tx({ id: "Stone.ShinyRock1", atlas: 0, x: 902, y: 717, width: 24, height: 18 }),
      ShinyRockWall0: tx({ id: "Stone.ShinyRockWall0", atlas: 0, x: 502, y: 834, width: 78, height: 48 }),
    },
    Terrain: {
      Earth: {
        Asterisk: tx({ id: "Terrain.Earth.Asterisk", atlas: 0, x: 926, y: 736, width: 21, height: 24 }),
        ...
        CrackSmall0: tx({ id: "Terrain.Earth.CrackSmall0", atlas: 0, x: 598, y: 699, width: 8, height: 4 }),
        ExposedDirt: tx({ id: "Terrain.Earth.ExposedDirt", atlas: 0, x: 340, y: 739, width: 80, height: 14 }),
        Loop: tx({ id: "Terrain.Earth.Loop", atlas: 0, x: 972, y: 660, width: 17, height: 18 }),
        Mass0: tx({ id: "Terrain.Earth.Mass0", atlas: 0, x: 284, y: 922, width: 137, height: 81 }),
        QuestionMarkStencil0: tx({ id: "Terrain.Earth.QuestionMarkStencil0", atlas: 0, x: 931, y: 696, width: 22, height: 14 }),
        ...
        V: tx({ id: "Terrain.Earth.V", atlas: 0, x: 950, y: 711, width: 20, height: 18 }),
        ValuableBlue0: tx({ id: "Terrain.Earth.ValuableBlue0", atlas: 0, x: 928, y: 761, width: 20, height: 24 }),
        ValuableRed0: tx({ id: "Terrain.Earth.ValuableRed0", atlas: 0, x: 935, y: 681, width: 20, height: 14 }),
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 405, y: 841, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 897, y: 852, width: 14, height: 12 }),
        Brick0: tx({ id: "Town.Ball.Brick0", atlas: 0, x: 869, y: 595, width: 36, height: 30 }),
        Brick1: tx({ id: "Town.Ball.Brick1", atlas: 0, x: 845, y: 931, width: 36, height: 20 }),
        ColumnSpiral0: tx({ id: "Town.Ball.ColumnSpiral0", atlas: 0, x: 940, y: 660, width: 12, height: 20 }),
        Dice: tx({ id: "Town.Ball.Dice", atlas: 0, x: 408, y: 867, width: 10, height: 10 }),
        ...
        Symbols: {
          Circle: tx({ id: "Town.Ball.Symbols.Circle", atlas: 0, x: 906, y: 595, width: 28, height: 28 }),
          P: tx({ id: "Town.Ball.Symbols.P", atlas: 0, x: 899, y: 736, width: 26, height: 28 }),
          Square: tx({ id: "Town.Ball.Symbols.Square", atlas: 0, x: 845, y: 952, width: 34, height: 30 }),
      ...
      Colossus: {
        ...
        Eyelid0: tx({ id: "Town.Colossus.Eyelid0", atlas: 0, x: 954, y: 696, width: 20, height: 14 }),
        ...
        Nose0: tx({ id: "Town.Colossus.Nose0", atlas: 0, x: 878, y: 852, width: 18, height: 12 }),
        Pupil0: tx({ id: "Town.Colossus.Pupil0", atlas: 0, x: 1016, y: 164, width: 8, height: 16 }),
        Pupil1: tx({ id: "Town.Colossus.Pupil1", atlas: 0, x: 864, y: 783, width: 34, height: 14 }),
        Pupil2: tx({ id: "Town.Colossus.Pupil2", atlas: 0, x: 405, y: 854, width: 12, height: 12 }),
        Sclera0: tx({ id: "Town.Colossus.Sclera0", atlas: 0, x: 987, y: 603, width: 18, height: 24 }),
      ...
      Underneath: {
        ...
        RiserFaceHappy: tx({ id: "Town.Underneath.RiserFaceHappy", atlas: 0, x: 899, y: 765, width: 28, height: 20 }),
        RiserFaceSurprise: tx({ id: "Town.Underneath.RiserFaceSurprise", atlas: 0, x: 902, y: 696, width: 28, height: 20 }),
        RiserFace: tx({ id: "Town.Underneath.RiserFace", atlas: 0, x: 901, y: 786, width: 28, height: 20 }),
      },
    },
    Ui: {
      ...
      InteractionIndicator: tx({ id: "Ui.InteractionIndicator", atlas: 0, x: 948, y: 734, width: 22, height: 22 }),
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 102, y: 1016, width: 8, height: 8 }),
      OwnerDefeat: tx({ id: "Ui.OwnerDefeat", atlas: 0, x: 788, y: 1007, width: 30, height: 16 }),
    ...
    Wood: {
      ...
      Crate0: tx({ id: "Wood.Crate0", atlas: 0, x: 866, y: 798, width: 34, height: 30 }),
