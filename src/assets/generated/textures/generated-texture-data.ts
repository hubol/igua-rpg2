...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      BallFruitTypeA: tx({ id: "Collectibles.BallFruitTypeA", atlas: 0, x: 748, y: 504, width: 22, height: 20 }),
      BallFruitTypeB: tx({ id: "Collectibles.BallFruitTypeB", atlas: 0, x: 303, y: 404, width: 22, height: 20 }),
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 1014, y: 478, width: 8, height: 8 }),
      ValuableBlue: tx({ id: "Collectibles.ValuableBlue", atlas: 0, x: 605, y: 499, width: 17, height: 13 }),
      ValuableGreen: tx({ id: "Collectibles.ValuableGreen", atlas: 0, x: 172, y: 478, width: 7, height: 6 }),
      ValuableOrange: tx({ id: "Collectibles.ValuableOrange", atlas: 0, x: 477, y: 404, width: 17, height: 13 }),
    },
    Door: {
    ...
    Effects: {
      BoomText: tx({ id: "Effects.BoomText", atlas: 0, x: 971, y: 262, width: 44, height: 16 }),
      Bubble4: tx({ id: "Effects.Bubble4", atlas: 0, x: 948, y: 482, width: 4, height: 4 }),
      Burst32: tx({ id: "Effects.Burst32", atlas: 0, x: 678, y: 526, width: 32, height: 22 }),
      ...
      Star12px: tx({ id: "Effects.Star12px", atlas: 0, x: 947, y: 116, width: 12, height: 10 }),
      ValuableSparkle: tx({ id: "Effects.ValuableSparkle", atlas: 0, x: 642, y: 526, width: 35, height: 7 }),
    ...
    Enemy: {
      ...
      Suggestive: {
        ...
        Face: tx({ id: "Enemy.Suggestive.Face", atlas: 0, x: 806, y: 495, width: 38, height: 24 }),
        Gear: tx({ id: "Enemy.Suggestive.Gear", atlas: 0, x: 948, y: 510, width: 32, height: 16 }),
        ...
        Sclera: tx({ id: "Enemy.Suggestive.Sclera", atlas: 0, x: 664, y: 490, width: 8, height: 16 }),
    ...
    Esoteric: {
      Decoration: {
        ...
        SeedBag: tx({ id: "Esoteric.Decoration.SeedBag", atlas: 0, x: 711, y: 541, width: 32, height: 31 }),
      },
      Message: {
    ...
    Fiber: {
      RopeFrame: tx({ id: "Fiber.RopeFrame", atlas: 0, x: 673, y: 488, width: 37, height: 28 }),
    },
    Foliage: {
      Flower14: tx({ id: "Foliage.Flower14", atlas: 0, x: 1009, y: 99, width: 14, height: 8 }),
      Flower18: tx({ id: "Foliage.Flower18", atlas: 0, x: 711, y: 493, width: 18, height: 10 }),
      Leaf16: tx({ id: "Foliage.Leaf16", atlas: 0, x: 128, y: 614, width: 16, height: 16 }),
      Leaf36: tx({ id: "Foliage.Leaf36", atlas: 0, x: 627, y: 490, width: 36, height: 22 }),
      LeavesMedium0: tx({ id: "Foliage.LeavesMedium0", atlas: 0, x: 772, y: 420, width: 42, height: 60 }),
      Medium0: tx({ id: "Foliage.Medium0", atlas: 0, x: 477, y: 344, width: 26, height: 31 }),
      ...
      Stem16: tx({ id: "Foliage.Stem16", atlas: 0, x: 1009, y: 82, width: 14, height: 16 }),
      TallRoundRed: tx({ id: "Foliage.TallRoundRed", atlas: 0, x: 983, y: 334, width: 35, height: 88 }),
      Vine0: tx({ id: "Foliage.Vine0", atlas: 0, x: 1018, y: 444, width: 6, height: 33 }),
      Vine1: tx({ id: "Foliage.Vine1", atlas: 0, x: 287, y: 461, width: 14, height: 15 }),
    },
    Font: {
    ...
    Furniture: {
      Aquarium: {
        ...
        Coral: tx({ id: "Furniture.Aquarium.Coral", atlas: 0, x: 917, y: 523, width: 28, height: 26 }),
        ...
        WaterIntake: tx({ id: "Furniture.Aquarium.WaterIntake", atlas: 0, x: 303, y: 425, width: 22, height: 14 }),
      },
      ...
      Pottery18: tx({ id: "Furniture.Pottery18", atlas: 0, x: 856, y: 544, width: 18, height: 18 }),
      Table0: tx({ id: "Furniture.Table0", atlas: 0, x: 65, y: 607, width: 62, height: 22 }),
      WateringCan: tx({ id: "Furniture.WateringCan", atlas: 0, x: 948, y: 487, width: 34, height: 22 }),
    },
    Iguana: {
      Boiled: {
        ...
        Eye: tx({ id: "Iguana.Boiled.Eye", atlas: 0, x: 1009, y: 145, width: 12, height: 12 }),
        Foot: tx({ id: "Iguana.Boiled.Foot", atlas: 0, x: 762, y: 367, width: 210, height: 18 }),
        Head: tx({ id: "Iguana.Boiled.Head", atlas: 0, x: 974, y: 116, width: 27, height: 27 }),
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 1009, y: 158, width: 12, height: 12 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 681, y: 182, width: 210, height: 18 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 477, y: 376, width: 27, height: 27 }),
      ...
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 711, y: 504, width: 36, height: 36 }),
    },
    Light: {
      ...
      ShadowIrregularSmallRound: tx({ id: "Light.ShadowIrregularSmallRound", atlas: 0, x: 1009, y: 171, width: 12, height: 10 }),
      ShadowIrregularSmall: tx({ id: "Light.ShadowIrregularSmall", atlas: 0, x: 930, y: 116, width: 16, height: 8 }),
    },
    Placeholder: tx({ id: "Placeholder", atlas: 0, x: 1009, y: 108, width: 14, height: 14 }),
    Shapes: {
      Arc24: tx({ id: "Shapes.Arc24", atlas: 0, x: 711, y: 488, width: 24, height: 4 }),
      ...
      Confetti45deg: tx({ id: "Shapes.Confetti45deg", atlas: 0, x: 219, y: 579, width: 26, height: 26 }),
      Confetti18x8: tx({ id: "Shapes.Confetti18x8", atlas: 0, x: 1006, y: 279, width: 18, height: 8 }),
      Confetti32: tx({ id: "Shapes.Confetti32", atlas: 0, x: 981, y: 518, width: 32, height: 32 }),
      ...
      DitherSquare16: tx({ id: "Shapes.DitherSquare16", atlas: 0, x: 875, y: 556, width: 16, height: 16 }),
      LineVertical16: tx({ id: "Shapes.LineVertical16", atlas: 0, x: 475, y: 459, width: 1, height: 16 }),
      Rectangle6: tx({ id: "Shapes.Rectangle6", atlas: 0, x: 681, y: 275, width: 6, height: 3 }),
      RightTriangle24px: tx({ id: "Shapes.RightTriangle24px", atlas: 0, x: 917, y: 550, width: 24, height: 22 }),
      SquareIrregular10: tx({ id: "Shapes.SquareIrregular10", atlas: 0, x: 1014, y: 518, width: 10, height: 10 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 884, y: 523, width: 32, height: 32 }),
      X10: tx({ id: "Shapes.X10", atlas: 0, x: 1014, y: 529, width: 10, height: 10 }),
      X22: tx({ id: "Shapes.X22", atlas: 0, x: 303, y: 440, width: 22, height: 16 }),
      Zigzag14: tx({ id: "Shapes.Zigzag14", atlas: 0, x: 1009, y: 123, width: 14, height: 8 }),
    },
    Sky: {
    ...
    Stone: {
      RockLargeShaded: tx({ id: "Stone.RockLargeShaded", atlas: 0, x: 845, y: 517, width: 38, height: 26 }),
    ...
    Terrain: {
      Earth: {
        Asterisk: tx({ id: "Terrain.Earth.Asterisk", atlas: 0, x: 303, y: 379, width: 21, height: 24 }),
        Crack8px12px: tx({ id: "Terrain.Earth.Crack8px12px", atlas: 0, x: 806, y: 481, width: 8, height: 12 }),
        Crack28px38px: tx({ id: "Terrain.Earth.Crack28px38px", atlas: 0, x: 806, y: 520, width: 28, height: 38 }),
        ...
        Loop: tx({ id: "Terrain.Earth.Loop", atlas: 0, x: 767, y: 559, width: 17, height: 18 }),
        ...
        V: tx({ id: "Terrain.Earth.V", atlas: 0, x: 845, y: 495, width: 20, height: 18 }),
        ValuableBlue0: tx({ id: "Terrain.Earth.ValuableBlue0", atlas: 0, x: 785, y: 528, width: 20, height: 24 }),
        ValuableRed0: tx({ id: "Terrain.Earth.ValuableRed0", atlas: 0, x: 223, y: 531, width: 20, height: 14 }),
      ...
      Grass: {
        ...
        Shape1: tx({ id: "Terrain.Grass.Shape1", atlas: 0, x: 866, y: 477, width: 40, height: 8 }),
    ...
    Town: {
      Ball: {
        Ball0: tx({ id: "Town.Ball.Ball0", atlas: 0, x: 892, y: 556, width: 12, height: 12 }),
        Ball1: tx({ id: "Town.Ball.Ball1", atlas: 0, x: 1009, y: 132, width: 14, height: 12 }),
        Brick0: tx({ id: "Town.Ball.Brick0", atlas: 0, x: 748, y: 528, width: 36, height: 30 }),
        Brick1: tx({ id: "Town.Ball.Brick1", atlas: 0, x: 605, y: 513, width: 36, height: 20 }),
        ColumnSpiral0: tx({ id: "Town.Ball.ColumnSpiral0", atlas: 0, x: 130, y: 593, width: 12, height: 20 }),
        Dice: tx({ id: "Town.Ball.Dice", atlas: 0, x: 1014, y: 540, width: 10, height: 10 }),
        ...
        StructureHighlight: tx({ id: "Town.Ball.StructureHighlight", atlas: 0, x: 907, y: 482, width: 40, height: 40 }),
        ...
        Symbols: {
          Circle: tx({ id: "Town.Ball.Symbols.Circle", atlas: 0, x: 946, y: 527, width: 28, height: 28 }),
          P: tx({ id: "Town.Ball.Symbols.P", atlas: 0, x: 219, y: 550, width: 26, height: 28 }),
          Square: tx({ id: "Town.Ball.Symbols.Square", atlas: 0, x: 983, y: 487, width: 34, height: 30 }),
          Star: tx({ id: "Town.Ball.Symbols.Star", atlas: 0, x: 866, y: 486, width: 40, height: 30 }),
        },
      },
      Colossus: {
        Eyebrow0: tx({ id: "Town.Colossus.Eyebrow0", atlas: 0, x: 679, y: 517, width: 26, height: 8 }),
        Eyelid0: tx({ id: "Town.Colossus.Eyelid0", atlas: 0, x: 835, y: 544, width: 20, height: 14 }),
        Mouth0: tx({ id: "Town.Colossus.Mouth0", atlas: 0, x: 642, y: 517, width: 36, height: 8 }),
        ...
        Pupil0: tx({ id: "Town.Colossus.Pupil0", atlas: 0, x: 883, y: 235, width: 8, height: 16 }),
        Sclera0: tx({ id: "Town.Colossus.Sclera0", atlas: 0, x: 785, y: 553, width: 18, height: 24 }),
      },
      Signage: {
    ...
    Ui: {
      ...
      InteractionIndicator: tx({ id: "Ui.InteractionIndicator", atlas: 0, x: 744, y: 559, width: 22, height: 22 }),
      NoneChoice: tx({ id: "Ui.NoneChoice", atlas: 0, x: 1016, y: 262, width: 8, height: 8 }),
      PlacementReticle: tx({ id: "Ui.PlacementReticle", atlas: 0, x: 866, y: 465, width: 6, height: 6 }),
      Pocket: {
