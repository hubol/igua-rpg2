...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Iguana: {
      ...
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 21, y: 92, width: 8, height: 8 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 358, y: 66, width: 126, height: 12 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 338, y: 89, width: 18, height: 18 }),
      Horn: tx({ id: "Iguana.Horn", atlas: 0, x: 266, y: 89, width: 40, height: 8 }),
      Mouth: tx({ id: "Iguana.Mouth", atlas: 0, x: 485, y: 66, width: 48, height: 8 }),
      Nails: tx({ id: "Iguana.Nails", atlas: 0, x: 0, y: 92, width: 20, height: 6 }),
    ...
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 307, y: 89, width: 30, height: 32 }),
