...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 614, y: 60, width: 48, height: 8 }),
    ...
    Iguana: {
      Club: tx({ id: "Iguana.Club", atlas: 0, x: 712, y: 60, width: 48, height: 12 }),
      Crest: tx({ id: "Iguana.Crest", atlas: 0, x: 892, y: 65, width: 96, height: 16 }),
      Eye: tx({ id: "Iguana.Eye", atlas: 0, x: 1011, y: 7, width: 8, height: 8 }),
      Foot: tx({ id: "Iguana.Foot", atlas: 0, x: 765, y: 54, width: 126, height: 12 }),
      Head: tx({ id: "Iguana.Head", atlas: 0, x: 992, y: 7, width: 18, height: 18 }),
      Horn: tx({ id: "Iguana.Horn", atlas: 0, x: 663, y: 60, width: 48, height: 8 }),
      ...
      Pupil: tx({ id: "Iguana.Pupil", atlas: 0, x: 892, y: 56, width: 96, height: 8 }),
      Tail: tx({ id: "Iguana.Tail", atlas: 0, x: 765, y: 31, width: 140, height: 22 }),
      Torso: tx({ id: "Iguana.Torso", atlas: 0, x: 645, y: 69, width: 24, height: 24 }),
    },
    LockedDoor: tx({ id: "LockedDoor", atlas: 0, x: 614, y: 69, width: 30, height: 32 }),
    OpenDoor: tx({ id: "OpenDoor", atlas: 0, x: 989, y: 56, width: 30, height: 32 }),
    ...
    Ui: {
      ...
      PlacementReticle: tx({ id: "Ui.PlacementReticle", atlas: 0, x: 1011, y: 16, width: 6, height: 6 }),
    },
  };
}
