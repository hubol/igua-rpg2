...
async function createNoAtlasTx(tx: typeof Tx) {
    return {
        Effects: {
            ...
            CrackedEarth: await wrap(tx.Effects.CrackedEarth),
        },
        Enemy: {
            Brick: {
