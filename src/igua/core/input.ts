...
const gamepadControls: GamepadControls<Action> = {
    ...
    MoveLeft: [ button(StandardMapping.Button.PadLeft), axis(StandardMapping.Axis.JoystickLeftHorizontal, -1), axis(StandardMapping.Axis.JoystickRightHorizontal, -1) ],
    MoveRight: [ button(StandardMapping.Button.PadRight), axis(StandardMapping.Axis.JoystickLeftHorizontal, 1), axis(StandardMapping.Axis.JoystickRightHorizontal, 1) ],
    PauseMenuToggle: [ button(StandardMapping.Button.ControlLeft) ],
    SelectDown: [ button(StandardMapping.Button.PadDown), axisUnit(StandardMapping.Axis.JoystickLeft, [0, 1]), axisUnit(StandardMapping.Axis.JoystickRight, [0, 1]) ],
    SelectLeft: [ button(StandardMapping.Button.PadLeft), axisUnit(StandardMapping.Axis.JoystickLeft, [-1, 0]), axisUnit(StandardMapping.Axis.JoystickRight, [-1, 0]) ],
    SelectRight: [ button(StandardMapping.Button.PadRight), axisUnit(StandardMapping.Axis.JoystickLeft, [1, 0]), axisUnit(StandardMapping.Axis.JoystickRight, [1, 0]) ],
