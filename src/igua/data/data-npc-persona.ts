...
export namespace DataNpcPersona {
    ...
    export const { manifest, getById } = DataLib.create(
        "DataNpcPersona",
        {
            ...
            OlgaStudent0: { job: "Student", name: "Shalotta", looksId: "AnxiousAttachment" },
            OlgaStudent1: { job: "Student", name: "Mips", looksId: "BigStretch" },
            OlgaStudent2: { job: "Student", name: "Tine", looksId: "Porygonish" },
            OlgaStudent3: { job: "Student", name: "Jems", looksId: "Elongnated" },
            OhioStudent0: { job: "Student", name: "Leeks", looksId: "UnfortunateHistory" },
