...
export namespace DataPotion {
    ...
    export const { manifest, find, filter, getById, ids: Ids } = DataLib.create(
        "DataPotion",
        {
            ...
            RestoreHealthFull0: {
                name: "Wonder Berry",
                description: "Terrific fruit. Fully restores health.",
                stinkLineTint: 0x548FD8,
                texture: Tx.Collectibles.Potion.Blueberry,
                sound: Sfx.Effect.Potion.RestoreHealthBagged2,
                flags: flags("is_foodlike"),
                healthRestore: (status) => status.healthMax,
            },
            RestoreHealthFull1: {
                name: "Wonder Wich",
                description: "Terrific sandwich. Fully restores health. Appealing to lovers of grain.",
                stinkLineTint: 0x775A34,
                texture: Tx.Collectibles.Potion.Sandwich,
                sound: Sfx.Effect.Potion.RestoreHealthBagged2,
                flags: flags("is_foodlike"),
                healthRestore: (status) => status.healthMax,
            },
