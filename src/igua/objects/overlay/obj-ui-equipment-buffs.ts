...
const getBuffInformations = (function () {
    ...
    > = Object.assign(
        ...
        buff(
            "combat.spells.requirements.minPocketItemsCount",
            "Spell Requires: Pocket Item Count",
            "integer",
        ...
        buff("conditions.wetnessMaxIncreaseFactor", "Wetness Max", "percent", "benefit_when_positive"),
        buff(
        ...
        buff("motion.jump.automaticallyJump", "Auto Jump", "percent", "benefit_when_positive"),
        buff("motion.jump.takeDamageAmount", "On Jump: Take Damage", "integer", "benefit_when_negative"),
        buff(
            "motion.jump.takeDamageChance",
            "On Jump: Take Damage Chance",
            "percent",
            "benefit_when_negative",
        ),
